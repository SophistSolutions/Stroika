...
namespace   {
    namespace   Test1_ {
        void    Test1_BagIteratorTests_ (SortedBag<size_t>& s)
        {
        ...
        void    Test1_BagTimings_ (SortedBag<size_t>& s)
        {
#if     qPrintTimings
        ...
        void    Test1_On_Container_ (SortedBag<size_t>& s)
        {
            size_t  three = 3;
        ...
        void    Test1_On_Container_ (SortedBag<SimpleClass>& s)
        {
            SimpleClass three = 3;
        ...
        void    RunBasicBagTestsOnEachConcreteType_ ()
        {
            RunBasicBagTestsOnEachConcreteType_<SortedBag<size_t>> ();
            RunBasicBagTestsOnEachConcreteType_<SortedBag<SimpleClass>> ();
            RunBasicBagTestsOnEachConcreteType_<SortedBag_LinkedList<size_t>> ();
            RunBasicBagTestsOnEachConcreteType_<SortedBag_LinkedList<SimpleClass>> ();
        }
...
namespace   {
    namespace   Test2_TallyOf_ {
        ...
        void    RunBasicBagTestsOnEachConcreteType_ ()
        {
            SimpleTallyTest_<SortedBag<size_t>> ();
            SimpleTallyTest_<SortedBag<SimpleClass>> ();
            SimpleTallyTest_<SortedBag_LinkedList<size_t>> ();
            SimpleTallyTest_<SortedBag_LinkedList<SimpleClass>> ();
        }
...
namespace   {
    namespace   Test3_Equals_ {
        ...
        void    RunBasicBagTestsOnEachConcreteType_ ()
        {
            SimpleOpEqualsTest_<SortedBag<size_t>> ();
            SimpleOpEqualsTest_<SortedBag<SimpleClass>> ();
            SimpleOpEqualsTest_<SortedBag_LinkedList<size_t>> ();
            SimpleOpEqualsTest_<SortedBag_LinkedList<SimpleClass>> ();
        }
...
namespace   {
    namespace   Test4_IteratorsBasics_ {
        ...
        void    RunBasicBagTestsOnEachConcreteType_ ()
        {
            ...
            BasicIteratorTest_<SortedBag_LinkedList<size_t>> ();
            BasicIteratorTest_<SortedBag_LinkedList<SimpleClass>> ();
        }

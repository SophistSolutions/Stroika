...
namespace {
    ...
    void WriteTextStream_ (const wstring& w, ostream& out)
    {
        ...
        // out.write (reinterpret_cast<const char*> (bom.data ()), bom.size ());         // https://github.com/SophistSolutions/Stroika/issues/1114 (STK-982) - this should work (and I think is) - but causes later failure (reader) - so debug why
    ...
    GTEST_TEST (Foundation_DataExchange_XML, DOM_Update)
    {
        ...
        DoWithEachXMLProvider_ ([&] ([[maybe_unused]] auto saxParser, [[maybe_unused]] auto schemaFactory, [[maybe_unused]] auto domFactory) {
            ...
            // add an element
            {
                ...
                * 
                *   TBD about attributes - https://github.com/SophistSolutions/Stroika/issues/1131 (STK-999)
                */
                auto concept2Add = conceptsElt.Append (NameWithNamespace{kNS_, "ConceptDetails"});
                {
                    ...
                    // Using kNS_ in the SetAttribute call will produce schema validation failure with libxml2 - https://github.com/SophistSolutions/Stroika/issues/1131 (STK-999)

...
namespace Resources_ {
    constexpr
#include "Tests/33/SampleCCR.ccr.embed"
        constexpr
#include "Tests/33/ASTM_CCR_V1.xsd.embed"
        constexpr
#include "Tests/33/personal.xml.embed"
        constexpr
#include "Tests/33/personal.xsd.embed"
        constexpr
#include "Tests/33/HealthFrameWorks_v3.xml.embed"
        constexpr
#include "Tests/33/ReferenceContent-2012-03.xsd.embed"
}

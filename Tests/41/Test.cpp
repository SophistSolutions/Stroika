    ...
    namespace Test10_MutlipleThreadsReadingOneUpdateUsingSynchronizedContainer_ {
                ...
                Thread::Ptr walkerThread = Thread::New (
                    [&syncObj, &iterF] () {
                        ...
                        // turn workaround off 2023-12-06 to test
                             ...
                             *      https://github.com/SophistSolutions/Stroika/issues/129 (STK-700)
                             * 
                             *  To reproduce:
                             *      +   Use Ubuntu 2004
                            ...
                            /**
                             *  Note that this code is something of an ANTI-PATTERN (even once we fix https://github.com/SophistSolutions/Stroika/issues/129 (STK-700)).
        ...
        GTEST_TEST (Foundation_Execution_ThreadSafetyBuiltinObject, Test10_MutlipleThreadsReadingOneUpdateUsingSynchronizedContainer_)
        {
            ...
            if (Debug::kBuiltWithThreadSanitizer) {
                ...
                GTEST_SKIP () << "not run under TSAN - https://github.com/SophistSolutions/Stroika/issues/129";
            }
            int64_t cnt{};
            {

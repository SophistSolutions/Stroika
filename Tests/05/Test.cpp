 ...
 */
//  Foundation::Containers::Private::DoublyLinkedList
...
#include    "Stroika/Foundation/Containers/Concrete/Private/DoublyLinkedList.h"
...
namespace   {
    static  void    Test1()
    {
        ...
        { size_t i = 1; size_t cur; for (DoublyLinkedListMutator_Patch<size_t> it (someLL); it.More(&cur, true); i++) { if (i == 100) {it.AddAfter (1); break;} } } //   someLL.InsertAt(1, 100);

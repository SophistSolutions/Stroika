...
DEFAULT_LIBRARY_GEN_LINE+=\
	export PATH="$(TOOLS_PATH_ADDITIONS):$(PATH)";\
		"$(LIBTOOL)" /OUT:$(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$1) ${LIBTOOLFLAGS}  $(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$2)
endif
...
#MIDL_FLAGS+=	/I$(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$(StroikaRoot)IntermediateFiles/$(CONFIGURATION))
#MIDL_FLAGS+=	/I$(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$(StroikaRoot)Library/Sources)

DEFAULT_MIDL_LINE=\
	PATH="$(TOOLS_PATH_ADDITIONS):$(PATH)";\
		"$(MIDL)" \
			/iid $(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$4)\
			$(MIDL_FLAGS)\
			/h $(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$3) \
			/tlb $(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$2) \
			/target "NT60" \
			$(call FUNCTION_CONVERT_FILES_TO_COMPILER_NATIVE,$1)
endif

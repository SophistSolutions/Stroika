...
print STDERR "PrintEnvVarFromCommonBuildVars.pl DEPRECATED - USE GetConfigurationParameter - or call GetAugmentedEnvironmentVariablesForConfiguration internally as configure does\n";

...
Stylistically, Stroika differs from boost, in that it (relatively) embraces object oriented abstractions over templates-based genericity, despite their slight performance overheads (see [Stroika-Approach-To-Performance.md](Documentation/Stroika-Approach-To-Performance.md)) because the abstraction of type hierarchies is so much better suited to how people reason.

...
help:
	...
	@$(ECHO) "    run-tests:                   -    [REMOTE=] - eg. REMOTE=lewis@localhost; [VALGRIND=memcheck] to run with valgrind (EXTRA_VALGRIND_OPTIONS= can be used with valgrind)"
	@$(ECHO) "                                      OR VALGRIND_SUPPRESSIONS=\"OpenSSL.supp Common-Valgrind.supp BlockAllocation-Valgrind.supp\" make VALGRIND=memcheck run-tests"

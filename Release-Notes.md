...
<tr>
<td><a href="https://github.com/SophistSolutions/Stroika/commits/v2.0b7">v2.0b7</a><br/>2018-09-14</td>
<td>
	<ul>
		<li>https://github.com/SophistSolutions/Stroika/compare/v2.0b6...v2.0b7</li>
		<li>***not backward compatible - bugfix*** - Timezone::GetBiasInMinutesFromUTCType () returned seconds - not minutes - when eLocalTime;</li>
		<li>***not backward compatible - bugfix*** - DateTime::Parse () was returning localetime instead of timezone UNKNOWN - when no timezone specified</li>
		<li>HistoricalPerformanceRegressionTestResults/PerformanceDump-{Windows_VS2k17,Ubuntu1604_x86_64,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b7.txt</li>
		<li>Tested (passed regtests)
			<ul>
				<li>OUTPUT FILES: Tests/HistoricalRegressionTestResults/REGRESSION-TESTS-{Windows_VS2k17,Ubuntu1604_x86_64,,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b7-OUT.txt</li>
				<li>vc++2k17</li>
...
<td>
	<ul>
		...
		<li>Tested (passed regtests)
			<ul>
				<li>OUTPUT FILES: Tests/HistoricalRegressionTestResults/REGRESSION-TESTS-{Windows_VS2k17,Ubuntu1604_x86_64,,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b5-OUT.txt</li>
				<li>vc++2k17</li>
				<li>MacOS, XCode 9.3 (apple clang 9.2)</li>
				<li>gcc 5.4 (because used in Ubuntu 1604 - most recent LTS release)</li>
				<li>gcc 6.4</li>
...
<tr>
<td><a href="https://github.com/SophistSolutions/Stroika/commits/v2.0b4">v2.0b4</a><br/>2018-08-07</td>
<td>
	<ul>
		<li>https://github.com/SophistSolutions/Stroika/compare/v2.0b3...v2.0b4</li>
		<li>Support latest msvc compiler - 15.7.6</li>
		<li>if qCompilerAndStdLib_Supports_stdoptional || qCompilerAndStdLib_Supports_stdexperimentaloptional - define ToString for std::optional and operator optional<> on Optional object (to make interop with std::optional easier - converting in Stroika v2.1)</li>
		<li>tweak DNS regression test for change in remote canonical name of machine</li>
		<li>HistoricalPerformanceRegressionTestResults/PerformanceDump-{Windows_VS2k17,Ubuntu1604_x86_64,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b4.txt</li>
		<li>Tested (passed regtests)
			<ul>
				<li>OUTPUT FILES: Tests/HistoricalRegressionTestResults/REGRESSION-TESTS-{Windows_VS2k17,Ubuntu1604_x86_64,,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b4-OUT.txt</li>
				<li>vc++2k17</li>
				<li>MacOS, XCode 9.3 (apple clang 9.2)</li>
				<li>gcc 5.4 (because used in Ubuntu 1604 - most recent LTS release)</li>
				<li>gcc 6.4</li>
...
<tr>
<td><a href="https://github.com/SophistSolutions/Stroika/commits/v2.0b3">v2.0b3</a><br/>2018-06-27</td>
<td>
	<ul>
		<li>https://github.com/SophistSolutions/Stroika/compare/v2.0b2...v2.0b3</li>
		<li>Support latest msvc compiler - 15.7.4</li>
		<li>Minor cosmetic/docs</li>
		<li>HistoricalPerformanceRegressionTestResults/PerformanceDump-{Windows_VS2k17,Ubuntu1604_x86_64,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b3.txt</li>
		<li>Tested (passed regtests)
			<ul>
				<li>OUTPUT FILES: Tests/HistoricalRegressionTestResults/REGRESSION-TESTS-{Windows_VS2k17,Ubuntu1604_x86_64,,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b3-OUT.txt</li>
				<li>vc++2k17</li>
				<li>MacOS, XCode 9.3 (apple clang 9.2)</li>
				<li>gcc 5.4 (because used in Ubuntu 1604 - most recent LTS release)</li>
				<li>gcc 6.4</li>
...
<tr>
<td><a href="https://github.com/SophistSolutions/Stroika/commits/v2.0b2">v2.0b2</a><br/>2018-05-31</td>
<td>
	<ul>
		<li>https://github.com/SophistSolutions/Stroika/compare/v2.0b1...v2.0b2</li>
		<li>re-instate SharedStaticData (it was useful after all- HealthFrameWorks - better documented why)</li>
		<li>use new STL::equal() instead of older STL::Equals (diff api - STL::Equals still deprecated)</li>
		<li>fix missing update of 50 to 45 for # regtests change</li>
		<li>HistoricalPerformanceRegressionTestResults/PerformanceDump-{Windows_VS2k17,Ubuntu1604_x86_64,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b2.txt</li>
		<li>Tested (passed regtests)
			<ul>
				<li>OUTPUT FILES: Tests/HistoricalRegressionTestResults/REGRESSION-TESTS-{Windows_VS2k17,Ubuntu1604_x86_64,,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b2-OUT.txt</li>
				<li>vc++2k17</li>
				<li>MacOS, XCode 9.3 (apple clang 9.2)</li>
				<li>gcc 5.4 (because used in Ubuntu 1604 - most recent LTS release)</li>
				<li>gcc 6.4</li>
...
<tr>
<td><a href="https://github.com/SophistSolutions/Stroika/commits/v2.0b1">v2.0b1</a><br/>2018-05-29</td>
<td>
	<ul>
		<li>https://github.com/SophistSolutions/Stroika/compare/v2.0a234...v2.0b1</li>
		<li>Mark STL::Compare::Equals () functions as deprecated (use std::equal())</li>
		<li>lose lots of deprecated classes/files, incliding SharedStaticData<T>, CompareNormalizer etc</li>
		<li>Deletes archives and incomplete code/modules (from v2.0 branch - still in v2.1 branch)
			<ul>
				<li>Archives</li>
				<li>Containers: Association, Bag, KeyedCollection,LockFreeDataStrucytres</li>
				<li>Cache BloomFilter</li>
			</ul>
		</li>
		<li>HistoricalPerformanceRegressionTestResults/PerformanceDump-{Windows_VS2k17,Ubuntu1604_x86_64,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b1.txt</li>
		<li>Tested (passed regtests)
			<ul>
				<li>OUTPUT FILES: Tests/HistoricalRegressionTestResults/REGRESSION-TESTS-{Windows_VS2k17,Ubuntu1604_x86_64,,Ubuntu1804_x86_64,MacOS_XCode9.3}-2.0b1-OUT.txt</li>
				<li>vc++2k17</li>
				<li>MacOS, XCode 9.3 (apple clang 9.2)</li>
				...
				<li>bug with regtest - https://stroika.atlassian.net/browse/STK-535 - some suppression/workaround 
				    (qIterationOnCopiedContainer_ThreadSafety_Buggy) - and had to manually kill one memcheck valgrind cuz too slow</li>
				<li>IGNORE innocuous failure due to network connect error</li>
			</ul>
		</li>
	</ul>
</td>

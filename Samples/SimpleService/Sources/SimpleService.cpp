...
#if     qUseLogger
            //@todo fix to use #include of autogenerated verison stuff ... Logger::Log (Logger::Priority::eInfo, L"%s Service (version %s) started", kServiceDescription_.fPrettyName.c_str (), MyServiceVersion::kVersion.AsPrettyVersionString ().c_str ());
            Logger::Log (Logger::Priority::eInfo, L"User-service started");
#endif
            if (false) {

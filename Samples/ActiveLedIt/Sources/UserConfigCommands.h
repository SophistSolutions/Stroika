...
public:
    STDMETHOD(get_InternalCommandName)(BSTR* pVal);
    STDMETHOD(put_InternalCommandName)(BSTR val);
...
public:
    STDMETHOD(get_Name)(BSTR* pVal);
    STDMETHOD(get_InternalName)(BSTR* pVal);
    STDMETHOD(AppendSelfToMenu)(HMENU menu, IDispatch* acceleratorTable);
...
public:
    STDMETHOD(put_Name)(BSTR val);
    STDMETHOD(put_InternalName)(BSTR val);

// Not sure these needed/effective - maybe have to be in final class???
    // disambiguate mixins
public:
    STDMETHOD(get_Name)(BSTR* pVal)                                         {   return AL_CommandHelper::get_Name (pVal); }
    STDMETHOD(get_InternalName)(BSTR* pVal)                                 {   return AL_CommandHelper::get_InternalName (pVal); }
    STDMETHOD(AppendSelfToMenu)(HMENU menu, IDispatch* acceleratorTable)    {   return AL_CommandHelper::AppendSelfToMenu (menu, acceleratorTable); }
};
...
public:
    STDMETHOD(GeneratePopupMenu)(IDispatch* acceleratorTable, HMENU* val);
    STDMETHOD(LookupCommand)(BSTR internalName, IDispatch** val);
    STDMETHOD(IndexOf)(VARIANT internalNameOrObject, UINT* val);
...
public:
    ...
    // disambiguate mixins
public:
    STDMETHOD(GeneratePopupMenu)(IDispatch* acceleratorTable, HMENU* val)   {   return AL_CommandListHelper::GeneratePopupMenu (acceleratorTable, val); }
    STDMETHOD(LookupCommand)(BSTR internalName, IDispatch** val)            {   return AL_CommandListHelper::LookupCommand (internalName, val); }
    STDMETHOD(IndexOf)(VARIANT internalNameOrObject, UINT* val)             {   return AL_CommandListHelper::IndexOf (internalNameOrObject, val); }
    STDMETHOD(get__NewEnum)(IUnknown** ppUnk)                               {   return AL_CommandListHelper::get__NewEnum (ppUnk); }
    STDMETHOD(get_Item)(long Index, IDispatch** pVal)                       {   return AL_CommandListHelper::get_Item (Index, pVal); }
    STDMETHOD(get_Count)(long* pVal)                                        {   return AL_CommandListHelper::get_Count (pVal); }

public:
    STDMETHOD(Insert)(IDispatch* newElt, UINT afterElt = static_cast<UINT> (-1));
...
class   ATL_NO_VTABLE   ActiveLedIt_BuiltinCommand :
    public CComObjectRootEx<CComSingleThreadModel>,
...
public:
    STDMETHOD(get_CommandInternalName)(BSTR* pVal);
    STDMETHOD(put_CommandInternalName)(BSTR val);
    STDMETHOD(get_ModifierFlag)(AcceleratorModifierFlag* pVal);
    STDMETHOD(put_ModifierFlag)(AcceleratorModifierFlag val);
    STDMETHOD(get_Key)(WORD* pVal);
    STDMETHOD(put_Key)(WORD val);
...
public:
    ...
    STDMETHOD(get_Item)(long Index, IDispatch** pVal);
    STDMETHOD(get_Count)(long* pVal);
    STDMETHOD(Lookup)(BSTR cmdInternalName, IDispatch** pVal);
    STDMETHOD(Add) (IDispatch* newElt, UINT atIndex = 0xffffffff);
    STDMETHOD(Remove)(VARIANT eltIntNameOrIndex);
    STDMETHOD(Clear)();
    STDMETHOD(GenerateWin32AcceleratorTable)(HACCEL* pVal);
...
class   ATL_NO_VTABLE   ActiveLedIt_StaticCommandList :
    public CComObjectRootEx<CComSingleThreadModel>,
...
class   ATL_NO_VTABLE   ActiveLedIt_UserCommandList :
    public CComObjectRootEx<CComSingleThreadModel>,
...
public:
    ...
    // disambiguate mixins
public:
    STDMETHOD(GeneratePopupMenu)(IDispatch* acceleratorTable, HMENU* val)   {   return AL_UserCommandListHelper::GeneratePopupMenu (acceleratorTable, val); }
    STDMETHOD(LookupCommand)(BSTR internalName, IDispatch** val)            {   return AL_UserCommandListHelper::LookupCommand (internalName, val); }
    STDMETHOD(IndexOf)(VARIANT internalNameOrObject, UINT* val)             {   return AL_UserCommandListHelper::IndexOf (internalNameOrObject, val); }
    STDMETHOD(get__NewEnum)(IUnknown** ppUnk)                               {   return AL_UserCommandListHelper::get__NewEnum (ppUnk); }
    STDMETHOD(get_Item)(long Index, IDispatch** pVal)                       {   return AL_UserCommandListHelper::get_Item (Index, pVal); }
    STDMETHOD(get_Count)(long* pVal)                                        {   return AL_UserCommandListHelper::get_Count (pVal); }
...
public:
    STDMETHOD(put_Name)(BSTR val)                                           {   return AL_UserCommandHelper::put_Name (val); }
    STDMETHOD(put_InternalName)(BSTR val)                                   {   return AL_UserCommandHelper::put_InternalName (val); }

public:
    STDMETHOD(Insert)(IDispatch*, UINT = static_cast<UINT> (-1));
    STDMETHOD(Remove)(VARIANT eltIntNameOrIndex);
    STDMETHOD(Clear)();

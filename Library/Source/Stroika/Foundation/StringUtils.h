...
#if 0
/*
 * SHOULD maybe get rid of this, but used in many places, and would just have to globally say using	StringUtils::tstring someplace else????
 *
 *		-- LGP 2011-03-20
 */

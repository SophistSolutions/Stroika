...
if (($x ne "/cygdrive/c/Program Files (x86)/Microsoft Visual Studio 11.0/VC/bin/ml") and ($x ne "/cygdrive/c/Program Files/Microsoft Visual Studio 11.0/VC/bin/ml")) {
...
if (($x ne "/cygdrive/c/Program Files (x86)/Microsoft Visual Studio 11.0/VC/bin/lib") and ($x ne "/cygdrive/c/Program Files/Microsoft Visual Studio 11.0/VC/bin/lib")) {

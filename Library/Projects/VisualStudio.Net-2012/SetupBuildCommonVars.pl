...
$ENV{'PATH'} = $ENV{'PATH'} . ":$PROGRAMFILESDIR/Microsoft Visual Studio 11.0/VC/";
$ENV{'PATH'} = $ENV{'PATH'} . ":/cygdrive/c/Program Files (x86)/Microsoft Visual Studio 11.0/VC/";
$ENV{'PATH'} = $ENV{'PATH'} . ":$PROGRAMFILESDIR/Microsoft Visual Studio 11.0/VC/vcpackages/";
$ENV{'PATH'} = $ENV{'PATH'} . ":/cygdrive/c/Program Files (x86)/Microsoft Visual Studio 11.0/VC/vcpackages/";

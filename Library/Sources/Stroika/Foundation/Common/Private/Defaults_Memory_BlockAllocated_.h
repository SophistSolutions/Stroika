 ...
 */
#ifndef _Stroika_Foundation_Common_Private_Defaults_Memory_BlockAllocated_h_
#define _Stroika_Foundation_Common_Private_Defaults_Memory_BlockAllocated_h_ 1
...
#endif /*_Stroika_Foundation_Common_Private_Defaults_Memory_BlockAllocated_h_*/

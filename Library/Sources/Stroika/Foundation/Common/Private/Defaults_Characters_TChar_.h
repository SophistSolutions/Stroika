 ...
 */
#ifndef _Stroika_Foundation_Common_Private_Defaults_Characters_TChar_h_
#define _Stroika_Foundation_Common_Private_Defaults_Characters_TChar_h_ 1
...
#endif /*_Stroika_Foundation_Common_Private_Defaults_Characters_TChar_h_*/

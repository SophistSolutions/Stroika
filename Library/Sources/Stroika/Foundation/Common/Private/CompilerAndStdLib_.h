...
Stack dump:
0.      Program arguments: clang++-14 --std=c++2b -I/Sandbox/Stroika-Dev/Builds/clang++-14-debug-libc++-c++2b/ThirdPartyComponents/include/ -I/Sandbox/Stroika-Dev/Library/Sources/ -I/Sandbox/Stroika-Dev/IntermediateFiles/clang++-14-debug-libc++-c++2b/ -Wall -Wno-switch -Wno-sign-compare -Wno-unused-function -Wno-unused-local-typedef -Wno-future-compat -Wno-unknown-attributes -fvisibility=hidden -g -D_GLIBCXX_DEBUG -DqDebug=1 -DqStroika_HasComponent_libcurl=1 -DqStroika_HasComponent_OpenSSL=1 -DqStroika_HasComponent_WinHTTP=0 -DqStroika_HasComponent_xerces=1 -DqStroika_HasComponent_zlib=1 -DqStroika_HasComponent_sqlite=1 -DqStroika_HasComponent_LZMA=1 -DqStroika_HasComponent_boost=1 -DqTraceToFile=1 -DqDefaultTracingOn=1 -fsanitize=address,undefined -stdlib=libc++ -c VariantValue.cpp -o /Sandbox/Stroika-Dev/IntermediateFiles/clang++-14-debug-libc++-c++2b/Library/Foundation/DataExchange/VariantValue.o
 ...
 * PLEASE submit a bug report to https://github.com/llvm/llvm-project/issues/ and include the crash backtrace, preprocessed source, and associated run script.
Stack dump:
0.      Program arguments: clang++-15 -I/Sandbox/Stroika-Dev/Builds/clang++-15-debug-libstdc++-c++23/ThirdPartyComponents/include/ -I/Sandbox/Stroika-Dev/Library/Sources/ -I/Sandbox/Stroika-Dev/IntermediateFiles/clang++-15-debug-libstdc++-c++23/ -I/Sandbox/Stroika-Dev/Builds/clang++-15-debug-libstdc++-c++23/ThirdPartyComponents/include/libxml2/ -D_GLIBCXX_DEBUG -DqDebug=1 -DqStroika_HasComponent_libcurl=1 -DqStroika_HasComponent_OpenSSL=1 -DqStroika_HasComponent_WinHTTP=0 -DqStroika_HasComponent_ATLMFC=0 -DqStroika_HasComponent_xerces=0 -DqStroika_HasComponent_libxml2=1 -DqStroika_HasComponent_zlib=1 -DqStroika_HasComponent_googletest=1 -DqStroika_HasComponent_sqlite=1 -DqStroika_HasComponent_LZMA=1 -DqStroika_HasComponent_boost=1 -DqStroika_Foundation_Debug_TraceToFile=1 -DqStroika_Foundation_Debug_DefaultTracingOn=1 -DLIBXML_STATIC --std=c++2b -Wall -Wno-switch -Wno-sign-compare -Wno-unused-function -Wno-psabi -Wno-unused-local-typedef -Wno-future-compat -Wno-unqualified-std-cast-call -g -fsanitize=address,undefined -stdlib=libstdc++ -c FloatConversion.cpp -o /Sandbox/Stroika-Dev/IntermediateFiles/clang++-15-debug-libstdc++-c++23/Library/Foundation/Characters/FloatConversion.o
...
oika/Foundation/Debug/Debugger.cpp ... 
...
In file included from SystemConfiguration.cpp:48:
/Sandbox/Stroika-Dev/Library/Sources/Stroika/Foundation/Execution/ProcessRunner.h:232:105: error: default member initializer for 'fDetached' needed within definition of enclosing
      class 'ProcessRunner' outside of member functions
  232 |         ProcessRunner (const filesystem::path& executable, const CommandLine& args, const Options& o = {});
      |                                                                                                         ^
/Sandbox/Stroika-Dev/Library/Sources/Stroika/Foundation/Execution/ProcessRunner.h:189:18: note: default member initializer d
...
#define qCompilerAndStdLib_deduce_template_arguments_Using_Buggy CompilerAndStdLib_AssumeBuggyIfNewerCheck_ (__GNUC__ <= 13)
#else
...
PLEASE submit a bug report to https://github.com/llvm/llvm-project/issues/ and include the crash backtrace, preprocessed source, and associated run script.
Stack dump:
0.  Program arguments: clang++-15 --std=c++2b -I/__w/Stroika/Stroika/Builds/Debug/ThirdPartyComponents/include/ -I/__w/Stroika/Stroika/Library/Sources/ -I/__w/Stroika/Stroika/IntermediateFiles/Debug/ -Wall -Wno-switch -Wno-sign-compare -Wno-unused-function -Wno-unused-local-typedef -Wno-future-compat -Wno-unqualified-std-cast-call -fvisibility=hidden -g -D_GLIBCXX_DEBUG -DqDebug=1 -DqStroika_HasComponent_libcurl=1 -DqStroika_HasComponent_OpenSSL=1 -DqStroika_HasComponent_WinHTTP=0 -DqStroika_HasComponent_xerces=1 -DqStroika_HasComponent_zlib=1 -DqStroika_HasComponent_sqlite=1 -DqStroika_HasComponent_LZMA=1 -DqStroika_HasComponent_boost=1 -DqTraceToFile=1 -DqDefaultTracingOn=1 -fsanitize=address,undefined -stdlib=libc++ -c CodeCvt.cpp -o /__w/Stroika/Stroika/IntermediateFiles/Debug/Library/Foundation/Characters/CodeCvt.o
 ...
 *  %a %b %e %T %Y - as is suggested by code docs and https://en.cppreference.com/w/cpp/locale/time_put/put (example - not clear cuz not for all locales)
 ...
 Which is: 00007FF6608438C0                  [  FAILED  ] Foundation_Time.DateTime_eCurrentLocale_WithZerosStripped (22 ms)  
  ...
  C:\Sandbox\Stroika\DevRoot\Tests\50\Test.cpp(211): error: Expected equality of these values:           resultTM.tm_mday             Which is: 3           kTargetTM_MDY_.tm_mday             Which is: 7                  C:\Sandbox\Stroika\DevRoot\Tests\50\Test.cpp(212): error: Expected equality of these values:           resultTM.tm_mon             Which is: 6           kTargetTM_MDY_.tm_mon             Which is: 2                  [  FAILED  ] Foundation_Time.AssumptionsAboutUnderlyingTimeLocaleLibrary_ 
 ...
 * 
 *  NOTE - though not directly related to this bug, this is AGGRAVATED and of extra importance because of
 *          StdCPctxTraits::kLocaleClassic_Write4DigitYear being false
 * 
 * 
         C:\Sandbox\Stroika\DevRoot\Tests\50\Test.cpp(211): error: Expected equality of these values:           resultTM.tm_mday             Which is: 3           kTargetTM_MDY_.tm_mday             Which is: 7                  C:\Sandbox\Stroika\DevRoot\Tests\49\Test.cpp(212): error: Expected equality of these values:           resultTM.tm_mon             Which is: 6           kTargetTM_MDY_.tm_mon
  ...
  C:\Sandbox\Stroika\DevRoot\Tests\50\Test.cpp(211): error: Expected equality of these values:
  resultTM.tm_mday
    Which is: 3
  kTargetTM_MDY_.tm_mday
    Which is: 7
...
// FAILED: RegressionTestFailure; not initializedLocale;;C:\Sandbox\Stroika\DevRoot\Tests\02\Test.cpp: 1203
 C:\Sandbox\Stroika\DevRoot\Tests\02\Test.cpp(1389): error: Value of: not initializedLocale           Actual: false         Expected: true                  [  FAILED  ] Foundation_Characters.LocaleUNICODEConversions_ (762 ms)         [==========] 52 tests from 1 test suite ran. (5521 ms total)         [  PASSED  ] 51 tests.
 */

...
//static_assert (ENUM::eSTART <= e and e <= ENUM::eEND);
             ...
             */
            template <typename ENUM>
            inline constexpr typename make_unsigned_t<typename underlying_type<ENUM>::type> GetDistanceSpanned ()
            {
                return static_cast<typename make_unsigned_t<typename underlying_type<ENUM>::type>> (ENUM::eCOUNT);
            }
...
//static_assert (ENUM::eSTART <= static_cast<ENUM> (e) and static_cast<ENUM> (e) <= ENUM::eEND);
             ...
             */
            template <typename ENUM>
            inline constexpr typename make_unsigned_t<typename underlying_type<ENUM>::type> OffsetFromStart (ENUM e)
            {
#if !qCompilerAndStdLib_constexpr_functions_cpp14Constaints_Buggy
// https://stroika.atlassian.net/browse/STK-549
//static_assert (ENUM::eSTART <= e and e <= ENUM::eEND);
#endif
                return static_cast<typename make_unsigned_t<typename underlying_type<ENUM>::type>> (ToInt (e) - ToInt (ENUM::eSTART));
            }
            template <typename ENUM>
            inline constexpr ENUM OffsetFromStart (typename make_unsigned_t<typename underlying_type<ENUM>::type> offset)
            {
            ...
            inline constexpr void EnumNames<ENUM_TYPE>::RequireItemsOrderedByEnumValue_ () const
            {
                ...
                using IndexType = typename make_unsigned_t<typename underlying_type<ENUM_TYPE>::type>;

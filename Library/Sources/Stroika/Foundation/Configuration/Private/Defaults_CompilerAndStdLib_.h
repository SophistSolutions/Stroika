...
#elif defined(__clang__) && !defined(__APPLE__)
#define qCompilerAndStdLib_DefaultCTORNotAutoGeneratedSometimes_Buggy CompilerAndStdLib_AssumeBuggyIfNewerCheck_ ((__clang_major__ < 3) || ((__clang_major__ == 3) && (__clang_minor__ <= 7)))
#else

...
#define qCANNOT_FIGURE_OUT_HOW_TO_INIT_STD_ARRAY_FROM_STD_INITIALIZER_ 1
             ...
             */
            template <typename ENUM>
            constexpr typename make_unsigned_t<typename underlying_type<ENUM>::type> GetDistanceSpanned (ENUM e);
            ...
            template <typename ENUM>
            constexpr ENUM OffsetFromStart (typename make_unsigned_t<typename underlying_type<ENUM>::type> offset);

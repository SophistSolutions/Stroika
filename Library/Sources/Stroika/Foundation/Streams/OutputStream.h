...
namespace Stroika::Foundation {
    namespace Streams {
        ...
        public:
            ...
            template <typename TEST_TYPE = ELEMENT_TYPE, typename ENABLE_IF_TEST = enable_if_t<is_same_v<TEST_TYPE, Characters::Character>>>
        ...
        public:
             ...
             */
            template <typename POD_TYPE, typename TEST_TYPE = ELEMENT_TYPE, typename ENABLE_IF_TEST = enable_if_t<is_same_v<TEST_TYPE, Memory::Byte>>>
        ...
        public:
             ...
             *  \req IsOpen ()
             */
            template <typename T, typename TEST_TYPE = ELEMENT_TYPE, typename ENABLE_IF_TEST = enable_if_t<is_same_v<TEST_TYPE, Characters::Character>>>

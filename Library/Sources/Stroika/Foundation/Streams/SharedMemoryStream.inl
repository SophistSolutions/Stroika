...
namespace Stroika::Foundation::Streams::SharedMemoryStream {
    ...
    namespace Private_ {
        ...
        private:
            ...
            qStroika_ATTRIBUTE_NO_UNIQUE_ADDRESS_VCFORCE conditional_t<kLocking_, Execution::WaitableEvent, Common::Empty> fMoreDataWaiter_{}; // not a race cuz always set/reset when holding fMutex; no need to pre-set cuz auto set when someone adds data (Write)
        ...
        private:
            qStroika_ATTRIBUTE_NO_UNIQUE_ADDRESS_VCFORCE mutable LOCK_IMPL fMutex_;

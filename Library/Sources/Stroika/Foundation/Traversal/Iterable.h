...
namespace Stroika::Foundation::Traversal {
    ...
    private:
        ...
        qStroika_ATTRIBUTE_NO_UNIQUE_ADDRESS_TRY_ANYHOW Debug::AssertExternallySynchronizedMutex::ReadContext fAssertReadLock_;
#endif
    };
...
#if qStroika_Foundation_Debug_AssertionsChecked
        qStroika_ATTRIBUTE_NO_UNIQUE_ADDRESS_TRY_ANYHOW Debug::AssertExternallySynchronizedMutex::WriteContext fAssertWriteLock_;
    ...
    struct Iterable<T>::SequentialEqualsComparer : Common::ComparisonRelationDeclarationBase<Common::ComparisonRelationType::eEquals> {
        ...
        qStroika_ATTRIBUTE_NO_UNIQUE_ADDRESS_TRY_ANYHOW T_EQUALS_COMPARER fElementComparer;
    ...
    struct Iterable<T>::SequentialThreeWayComparer : Common::ComparisonRelationDeclarationBase<Common::ComparisonRelationType::eThreeWayCompare> {
        ...
        qStroika_ATTRIBUTE_NO_UNIQUE_ADDRESS_TRY_ANYHOW T_THREEWAY_COMPARER fElementComparer;
    };

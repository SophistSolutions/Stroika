...
namespace   Stroika {
    namespace   Foundation {
        namespace   Traversal {
            ...
            /*
            ********************************************************************************
            ****************** Iterator<T, BASE_ITERATOR>::Rep_Cloner_ *********************
            ********************************************************************************
            */
            template    <typename T, typename BASE_ITERATOR>
            inline  typename IteratorBase::SharedPtrImplementationTemplate<typename Iterator<T, BASE_ITERATOR>::IRep>  Iterator<T, BASE_ITERATOR>::Rep_Cloner_::Copy (const IRep& t)
            {
                return Iterator<T, BASE_ITERATOR>::Clone_ (t);
            }


            /*
            ********************************************************************************
            ************************ Iterator<T, BASE_ITERATOR>::IRep **********************
            ********************************************************************************
            */
            template    <typename T, typename BASE_ITERATOR>
            inline Iterator<T, BASE_ITERATOR>::IRep::IRep ()
            {
            }
            template    <typename T, typename BASE_ITERATOR>
            inline Iterator<T, BASE_ITERATOR>::IRep::~IRep ()
            ...
            */
            template    <typename T, typename BASE_ITERATOR>
            inline Iterator<T, BASE_ITERATOR>::Iterator (const Iterator& from)
                : inherited ()
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline Iterator<T, BASE_ITERATOR>::Iterator (const SharedIRepPtr& rep)
                : fIterator_ (rep)
                , fCurrent_ ()
            {
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline Iterator<T, BASE_ITERATOR>::Iterator (ConstructionFlagForceAtEnd_)
                : fIterator_ (nullptr)
                , fCurrent_ ()
            {
                Assert (Done ());
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline Iterator<T, BASE_ITERATOR>&    Iterator<T, BASE_ITERATOR>::operator= (const Iterator& rhs)
            {
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline  typename    Iterator<T, BASE_ITERATOR>::IRep&         Iterator<T, BASE_ITERATOR>::GetRep ()
            {
                EnsureNotNull (fIterator_);
                return *fIterator_;
            }
            template    <typename T, typename BASE_ITERATOR>
            inline  const typename Iterator<T, BASE_ITERATOR>::IRep&   Iterator<T, BASE_ITERATOR>::GetRep () const
            {
                EnsureNotNull (fIterator_);
                return *fIterator_;
            }
            template    <typename T, typename BASE_ITERATOR>
            inline T   Iterator<T, BASE_ITERATOR>::Current () const
            {
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline bool    Iterator<T, BASE_ITERATOR>::Done () const
            {
                return fCurrent_.IsMissing ();
            }
            template    <typename T, typename BASE_ITERATOR>
            inline IteratorOwnerID    Iterator<T, BASE_ITERATOR>::GetOwner () const
            {
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline    T   Iterator<T, BASE_ITERATOR>::operator* () const
            {
                Require (not Done ());
                RequireNotNull (fIterator_);
                return *fCurrent_;
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline    T*   Iterator<T, BASE_ITERATOR>::operator-> ()
            {
                Require (not Done ());
                RequireNotNull (fIterator_);
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline    const T*   Iterator<T, BASE_ITERATOR>::operator-> () const
            {
                Require (not Done ());
                RequireNotNull (fIterator_);
                return fCurrent_.get ();
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline   void   Iterator<T, BASE_ITERATOR>::operator++ ()
            {
                Require (not Done ());
                RequireNotNull (fIterator_);
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline   void   Iterator<T, BASE_ITERATOR>::operator++ (int)
            {
                RequireNotNull (fIterator_);
                Require (not Done ());
                fIterator_->More (&fCurrent_, true);
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline   Iterator<T, BASE_ITERATOR>   Iterator<T, BASE_ITERATOR>::operator+ (int i) const
            {
                Require (i >= 0);
                Iterator<T, BASE_ITERATOR> tmp { *this };
                while (i > 0) {
                    --i;
                    ++tmp;
                }
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline  Iterator<T, BASE_ITERATOR>::operator bool () const
            {
                return not Done ();
            }
            template    <typename T, typename BASE_ITERATOR>
            inline  bool    Iterator<T, BASE_ITERATOR>::Equals (const Iterator& rhs) const
            {
                ...
                const   Iterator<T, BASE_ITERATOR>::IRep* lhsRep = fIterator_.cget ();
                const   Iterator<T, BASE_ITERATOR>::IRep* rhsRep = rhs.fIterator_.cget ();
            ...
            template    <typename T, typename BASE_ITERATOR>
            inline  Iterator<T, BASE_ITERATOR> Iterator<T, BASE_ITERATOR>::GetEmptyIterator ()
            {
                return Iterator<T, BASE_ITERATOR> (ConstructionFlagForceAtEnd_::ForceAtEnd);
            }

...
namespace Stroika::Foundation::DataExchange::Variant::CharacterDelimitedLines {
    ...
    inline Iterable<Sequence<String>> Reader::ReadMatrix (const Memory::BLOB& in) { return ReadMatrix (_ToByteReader (in)); }
    inline Iterable<Sequence<String>> Reader::ReadMatrix (istream& in) { return ReadMatrix (_ToByteReader (in)); }
    inline Iterable<Sequence<String>> Reader::ReadMatrix (wistream& in) { return ReadMatrix (_ToCharacterReader (in)); }

...
namespace Stroika::Foundation::DataExchange::Variant::CharacterDelimitedLines {
     ...
     ********************************************************************************
     */
    inline void Writer::Write (const Traversal::Iterable<Sequence<String>>& m, ostream& out) { Write (m, _WrapBinaryOutput (out)); }
    inline void Writer::Write (const Traversal::Iterable<Sequence<String>>& m, wostream& out) { Write (m, _WrapTextOutput (out)); }

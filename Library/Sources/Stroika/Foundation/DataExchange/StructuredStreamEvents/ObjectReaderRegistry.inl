 ...
 */
#ifndef _Stroika_Foundation_DataExchange_ObjectReaderRegistry_inl_
#define _Stroika_Foundation_DataExchange_ObjectReaderRegistry_inl_  1
    ...
    namespace   Foundation {
        namespace   DataExchange {
            namespace   StructuredStreamEvents {
                ...
                /*
                 ********************************************************************************
                 ******************* StructuredStreamEventObjectReaderRegistry::StructureFieldInfo ********************
                 ********************************************************************************
                 */
                inline  ObjectReaderRegistry::StructureFieldInfo::StructureFieldInfo (size_t fieldOffset, type_index typeInfo, const String& serializedFieldName, NullFieldHandling nullFields, ArrayElementHandling arrayHandling)
                    : fOffset (fieldOffset)
                    , fTypeInfo (typeInfo)
                ...
                /*
                 ********************************************************************************
                 *********** DataExchange::ObjectReaderRegistry::TypeMappingDetails **************
                 ********************************************************************************
                 */
                inline  ObjectReaderRegistry::TypeMappingDetails::TypeMappingDetails (const type_index& forTypeInfo, const ToVariantMapperType& toVariantMapper, const FromVariantMapperType& fromVariantMapper)
                    : fForType (forTypeInfo)
                    , fToVariantMapper (toVariantMapper)
                    , fFromVariantMapper (fromVariantMapper)
                {
                }
                inline  bool ObjectReaderRegistry::TypeMappingDetails::operator== (const TypeMappingDetails& rhs) const
                {
                 ...
                 ********************************************************************************
                 */
                inline  ObjectReaderRegistry::TypesRegistry    ObjectReaderRegistry::GetTypeMappingRegistry () const
                {
                    return fTypeMappingRegistry_;
                }
                inline  void    ObjectReaderRegistry::SetTypeMappingRegistry (const TypesRegistry& s)
                {
                ...
                inline  void    ObjectReaderRegistry::AddClass (const Sequence<StructureFieldInfo>& fieldDescriptions)
                {
                ...
                template    <typename CLASS>
                void    ObjectReaderRegistry::AddClass (const std::initializer_list<StructureFieldInfo>& fieldDescriptions)
                {
                    return AddClass<CLASS> (Sequence<StructureFieldInfo> (fieldDescriptions));
                }
#endif
                template    <typename CLASS>
                void    ObjectReaderRegistry::AddClass (const StructureFieldInfo* fieldDescriptionsStart, const StructureFieldInfo* fieldDescriptionsEnd)
                {
                    return AddClass<CLASS> (Sequence<StructureFieldInfo> (fieldDescriptionsStart, fieldDescriptionsEnd));
                }
                template    <typename CLASS>
                inline  void    ObjectReaderRegistry::AddClass (const Sequence<StructureFieldInfo>& fieldDescriptions, function<void(VariantValue*)> preflightBeforeToObject)
                {
                    Add (MakeCommonSerializer_ForClassObject_ (typeid (CLASS), sizeof (CLASS), fieldDescriptions, preflightBeforeToObject));
                }
#if     !qCompilerAndStdLib_stdinitializer_ObjectVariantMapperBug
                template    <typename CLASS>
                void    ObjectReaderRegistry::AddClass (const std::initializer_list<StructureFieldInfo>& fieldDescriptions, function<void(VariantValue*)> preflightBeforeToObject)
                {
                    return AddClass<CLASS> (Sequence<StructureFieldInfo> (fieldDescriptions), preflightBeforeToObject);
                }
#endif
                template    <typename CLASS>
                void    ObjectReaderRegistry::AddClass (const StructureFieldInfo* fieldDescriptionsStart, const StructureFieldInfo* fieldDescriptionsEnd, function<void(VariantValue*)> preflightBeforeToObject)
                {
                    return AddClass<CLASS> (Sequence<StructureFieldInfo> (fieldDescriptionsStart, fieldDescriptionsEnd), preflightBeforeToObject);
                }
                inline auto ObjectReaderRegistry::ToObjectMapper (const type_index& forTypeInfo) const ->FromVariantMapperType
                {
                    Require (Lookup_ (forTypeInfo).fFromVariantMapper);
                    return Lookup_ (forTypeInfo).fFromVariantMapper;
                }
                template    <typename TYPE>
                inline  auto   ObjectReaderRegistry::ToObjectMapper () const -> FromVariantMapperType
                {
                    return ToObjectMapper (typeid (TYPE));
                }
                inline auto  ObjectReaderRegistry::FromObjectMapper (const type_index& forTypeInfo) const -> ToVariantMapperType
                {
                    Require (Lookup_ (forTypeInfo).fToVariantMapper);
                    return Lookup_ (forTypeInfo).fToVariantMapper;
                }
                template    <typename TYPE>
                inline  void    ObjectReaderRegistry::ToObject (const FromVariantMapperType& fromVariantMapper, const VariantValue& v, TYPE* into) const
                {
                    RequireNotNull (into);
                ...
                template    <typename TYPE>
                inline  void    ObjectReaderRegistry::ToObject (const VariantValue& v, TYPE* into) const
                {
                    RequireNotNull (into);
                    ToObject<TYPE> (ToObjectMapper<TYPE> (), v, reinterpret_cast<Byte*> (into));
                }
                template    <typename TYPE>
                inline  TYPE    ObjectReaderRegistry::ToObject (const FromVariantMapperType& fromVariantMapper, const VariantValue& v) const
                {
                    /*
                     *  NOTE: It is because of this line of code (the default CTOR for tmp) - that we ObjectReaderRegistry requires
                ...
                template    <typename TYPE>
                inline  TYPE    ObjectReaderRegistry::ToObject (const VariantValue& v) const
                {
                    return ToObject<TYPE> (ToObjectMapper<TYPE> (), v);
                }
                template    <typename TYPE>
                inline  auto   ObjectReaderRegistry::FromObjectMapper () const -> ToVariantMapperType
                {
                    return FromObjectMapper (typeid (TYPE));
                }
                template    <typename TYPE>
                inline  VariantValue    ObjectReaderRegistry::FromObject (const ToVariantMapperType& toVariantMapper, const TYPE& from) const
                {
                ...
                template    <typename TYPE>
                inline  VariantValue    ObjectReaderRegistry::FromObject (const TYPE& from) const
                {
                    return FromObjectMapper<TYPE> () (*this, reinterpret_cast<const Byte*> (&from));
                }
                template    <typename T>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer ()
                {
                ...
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Containers::Bijection<DOMAIN_TYPE, RANGE_TYPE, TRAITS>&)
                {
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (Bijection<DOMAIN_TYPE, RANGE_TYPE, TRAITS>), toVariantMapper, fromVariantMapper);
                }
                template    <typename T>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Containers::Collection<T>&)
                {
                    return MakeCommonSerializer_WithSimpleAdd_<Containers::Collection<T>> ();
                }
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Mapping<KEY_TYPE, VALUE_TYPE, TRAITS>&)
                {
                    return MakeCommonSerializer_WithKeyValuePairAdd_<KEY_TYPE, VALUE_TYPE, Mapping<KEY_TYPE, VALUE_TYPE, TRAITS>>  ();
                }
                template    <typename T, typename TRAITS>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Memory::Optional<T, TRAITS>&)
                {
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (Optional<T, TRAITS>), toVariantMapper, fromVariantMapper);
                }
                template    <typename T, typename TRAITS>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Execution::Synchronized<T, TRAITS>&)
                {
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (Synchronized<T, TRAITS>), toVariantMapper, fromVariantMapper);
                }
                template    <typename T>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Sequence<T>&)
                {
                    return MakeCommonSerializer_WithSimpleAddByAppend_<Sequence<T>> ();
                }
                template    <typename T>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const vector<T>&)
                {
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (ACTUAL_CONTAINER_TYPE), toVariantMapper, fromVariantMapper);
                }
                template    <typename T>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Set<T>&)
                {
                    return MakeCommonSerializer_WithSimpleAdd_<Set<T>> ();
                }
                template    <typename T>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Containers::SortedCollection<T>&)
                {
                    return MakeCommonSerializer_WithSimpleAdd_<Containers::SortedCollection<T>> ();
                }
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Containers::SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>&)
                {
                    return MakeCommonSerializer_WithKeyValuePairAdd_<KEY_TYPE, VALUE_TYPE, Containers::SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>>  ();
                }
                template    <typename T>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Containers::SortedSet<T>&)
                {
                    return MakeCommonSerializer_WithSimpleAdd_<Containers::SortedSet<T>> ();
                }
                template    <typename ACTUAL_CONTAINER_TYPE>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_WithSimpleAdd_ ()
                {
                ...
                template    <typename ACTUAL_CONTAINER_TYPE>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_WithSimpleAddByAppend_ ()
                {
                    using   T   =   typename ACTUAL_CONTAINER_TYPE::ElementType;
                    auto toVariantMapper = [](const ObjectReaderRegistry & mapper, const Byte * fromObjOfTypeT) -> VariantValue {
                        RequireNotNull (fromObjOfTypeT);
                ...
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_WithKeyValuePairAdd_ ()
                {
                    using   Characters::String_Constant;
                    auto toVariantMapper = [] (const ObjectReaderRegistry & mapper, const Byte * fromObjOfTypeT) -> VariantValue {
                        RequireNotNull (fromObjOfTypeT);
                ...
                inline  ObjectReaderRegistry::TypeMappingDetails     ObjectReaderRegistry::MakeCommonSerializer_ (const T (&)[SZ])
                {
                    using   Characters::String_Constant;
                    auto toVariantMapper = [] (const ObjectReaderRegistry & mapper, const Byte * fromObjOfTypeT) -> VariantValue {
                        RequireNotNull (fromObjOfTypeT);
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (T[SZ]), toVariantMapper, fromVariantMapper);
                }
                template    <typename T, typename TRAITS>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Traversal::DiscreteRange<T, TRAITS>&)
                {
                    return MakeCommonSerializer_Range_<Traversal::DiscreteRange<T, TRAITS>> ();
                }
                template    <typename T, typename TRAITS>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const Traversal::Range<T, TRAITS>&)
                {
                    return MakeCommonSerializer_Range_<Traversal::Range<T, TRAITS>> ();
                }
                template    <typename ENUM_TYPE>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_ (const ENUM_TYPE&,  typename std::enable_if<std::is_enum<ENUM_TYPE>::value >::type*)
                {
                    using   Characters::String_Constant;
                    /*
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (ENUM_TYPE), toVariantMapper, fromVariantMapper);
                }
                template    <typename ENUM_TYPE>
                ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_NamedEnumerations (const Containers::Bijection<ENUM_TYPE, String>& nameMap)
                {
                    using   Characters::String_Constant;
                    static_assert (std::is_enum<ENUM_TYPE>::value, "MakeCommonSerializer_NamedEnumerations only works for enum types");
                    using   SerializeAsType     =   typename std::underlying_type<ENUM_TYPE>::type;
                    static_assert (sizeof (SerializeAsType) == sizeof (ENUM_TYPE), "underlyingtype?");
                    auto toVariantMapper = [nameMap] (const ObjectReaderRegistry & mapper, const Byte * fromObjOfTypeT) -> VariantValue {
                        RequireNotNull (fromObjOfTypeT);
                        const ENUM_TYPE*  actualMember    =   reinterpret_cast<const ENUM_TYPE*> (fromObjOfTypeT);
                    ...
                    auto fromVariantMapper = [nameMap] (const ObjectReaderRegistry & mapper, const VariantValue & d, Byte * intoObjOfTypeT) -> void {
                        RequireNotNull (intoObjOfTypeT);
                        ENUM_TYPE*  actualInto  =   reinterpret_cast<ENUM_TYPE*> (intoObjOfTypeT);
                ...
                template    <typename ENUM_TYPE>
                inline  ObjectReaderRegistry::TypeMappingDetails  ObjectReaderRegistry::MakeCommonSerializer_NamedEnumerations (const Configuration::EnumNames<ENUM_TYPE>& nameMap)
                {
                ...
                ObjectReaderRegistry::TypeMappingDetails ObjectReaderRegistry::MakeCommonSerializer_ContainerWithStringishKey ()
                {
                    auto toVariantMapper = [] (const ObjectReaderRegistry & mapper, const Byte * fromObjOfTypeT) -> VariantValue {
                        RequireNotNull (fromObjOfTypeT);
                        ToVariantMapperType             keyMapper       { mapper.FromObjectMapper<KEY_TYPE> () };
                ...
                ObjectReaderRegistry::TypeMappingDetails ObjectReaderRegistry::MakeCommonSerializer_Range_ ()
                {
                    using   Characters::String_Constant;
                    auto toVariantMapper = [] (const ObjectReaderRegistry & mapper, const Byte * fromObjOfTypeT) -> VariantValue {
                        RequireNotNull (fromObjOfTypeT);
                    ...
                    return ObjectReaderRegistry::TypeMappingDetails (typeid (RANGE_TYPE), toVariantMapper, fromVariantMapper);
                }
...
#endif  /*_Stroika_Foundation_DataExchange_ObjectReaderRegistry_inl_*/

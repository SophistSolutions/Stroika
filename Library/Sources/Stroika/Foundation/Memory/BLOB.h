...
template <>
struct qStroika_Foundation_Characters_FMT_PREFIX_::formatter<Stroika::Foundation::Memory::BLOB, wchar_t> : Stroika::Foundation::Characters::ToStringFormatter<Stroika::Foundation::Memory::BLOB> {};
template <>
struct qStroika_Foundation_Characters_FMT_PREFIX_::formatter<Stroika::Foundation::Memory::BLOB, char> : Stroika::Foundation::Characters::ToStringFormatterASCII<Stroika::Foundation::Memory::BLOB> {};

 ...
 */
#ifndef _Stroika_Foundation_Database_Document_SQLite_h_
#define _Stroika_Foundation_Database_Document_SQLite_h_ 1
...
namespace Stroika::Foundation::Database::Document::SQLite {
    ...
    public:
        ...
        /**
         *  SQLITE_ENABLE_JSON1 = true (required)
         */
...
#endif /*_Stroika_Foundation_Database_Document_SQLite_h_*/

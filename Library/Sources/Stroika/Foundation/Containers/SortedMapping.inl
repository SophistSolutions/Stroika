    ...
    namespace Foundation {
        namespace Containers {
            ...
            SortedMapping<KEY_TYPE, MAPPED_VALUE_TYPE, TRAITS>::SortedMapping ()
                : inherited (move (Concrete::SortedMapping_Factory<KEY_TYPE, MAPPED_VALUE_TYPE, TRAITS>::mk ()))
            {
                _AssertRepValidType ();
            }
            template <typename KEY_TYPE, typename MAPPED_VALUE_TYPE, typename TRAITS>
            ...
            template <typename KEY_TYPE, typename MAPPED_VALUE_TYPE, typename TRAITS>
            inline SortedMapping<KEY_TYPE, MAPPED_VALUE_TYPE, TRAITS>::SortedMapping (const _SharedPtrIRep& src) noexcept
                : inherited (src)
            {
                RequireNotNull (src);
                _AssertRepValidType ();
            ...
            template <typename KEY_TYPE, typename MAPPED_VALUE_TYPE, typename TRAITS>
            inline SortedMapping<KEY_TYPE, MAPPED_VALUE_TYPE, TRAITS>::SortedMapping (_SharedPtrIRep&& src) noexcept
                : inherited (move (src))
            {

...
namespace   Stroika {
    namespace   Foundation {
        namespace   Containers {
            ...
            template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
            inline  SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>::SortedMapping (const SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>& src) noexcept
                : inherited (src)
            {
                _AssertRepValidType ();
            }
            template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
            inline  SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>::SortedMapping (SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>&& src) noexcept
                : inherited (move (src))
            {
                _AssertRepValidType ();
            }
            ...
            template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
            inline  SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>::SortedMapping (const _SharedPtrIRep& src) noexcept
                : inherited (src)
            {
                RequireNotNull (src);
                _AssertRepValidType ();
            ...
            template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
            inline  SortedMapping<KEY_TYPE, VALUE_TYPE, TRAITS>::SortedMapping (_SharedPtrIRep&& src) noexcept
                : inherited (move (src))
            {

...
namespace Stroika::Foundation::Containers::Factory {
    ...
    atomic<SortedKeyedCollection<T, KEY_TYPE, TRAITS> (*) (const KEY_EXTRACTOR& keyExtractor, const KEY_INORDER_COMPARER& keyComparer)> SortedKeyedCollection_Factory<KEY_TYPE, VALUE_TYPE, KEY_EXTRACTOR, KEY_INORDER_COMPARER>::sFactory_ (nullptr);
#endif
    template <typename T, typename KEY_TYPE, typename TRAITS, typename KEY_EXTRACTOR, typename KEY_INORDER_COMPARER>

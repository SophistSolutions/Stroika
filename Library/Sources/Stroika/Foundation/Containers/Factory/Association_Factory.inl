        ...
        namespace Containers {
            namespace Factory {
                ...
                */
                ...
                inline Association<KEY_TYPE, VALUE_TYPE> Association_Factory<KEY_TYPE, VALUE_TYPE, false_type>::Default_SFINAE_ (CHECK_KEY*, typename enable_if<Configuration::has_lt<CHECK_KEY>::value>::type*)
                {
                    return Concrete::Association_stdmap<KEY_TYPE, VALUE_TYPE> (); // OK to omit TRAITS (and not manually pass in equals) cuz checked using default traits so no need to specify traits here
                }
                template <typename KEY_TYPE, typename VALUE_TYPE>

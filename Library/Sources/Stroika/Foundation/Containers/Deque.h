    ...
    namespace   Foundation {
        namespace   Containers {
            ...
            public:
                ...
                template    < typename CONTAINER_OF_T, typename ENABLE_IF = typename enable_if < Configuration::has_beginend<CONTAINER_OF_T>::value and not std::is_convertible<const CONTAINER_OF_T*, const Deque<T>*>::value >::type >

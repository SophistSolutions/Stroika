...
namespace Stroika::Foundation::Containers {
    ...
    {
        using ITERABLE = typename Iterable<CountedValue<T>>;
        return ITERABLE::template SequentialThreeWayComparer{Common::ThreeWayComparerAdapter (GetInOrderComparer ())}(*this, rhs);
    }
#endif

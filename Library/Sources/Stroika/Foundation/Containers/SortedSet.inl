...
namespace Stroika::Foundation::Containers {
    ...
    template <typename T>
    template <typename INORDER_COMPARER, enable_if_t<Common::IsPotentiallyComparerRelation_Old<T, INORDER_COMPARER> ()>*>
    ...
    template <typename T>
    template <typename INORDER_COMPARER, typename CONTAINER_OF_ADDABLE, enable_if_t<Common::IsPotentiallyComparerRelation_Old<T, INORDER_COMPARER> () and Configuration::IsIterableOfT_v<CONTAINER_OF_ADDABLE, T>>*>
    ...
    template <typename T>
    template <typename INORDER_COMPARER, typename COPY_FROM_ITERATOR_OF_ADDABLE, enable_if_t<Common::IsPotentiallyComparerRelation_Old<T, INORDER_COMPARER> () and Configuration::is_iterator_v<COPY_FROM_ITERATOR_OF_ADDABLE>>*>

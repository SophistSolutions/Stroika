...
namespace Stroika {
    namespace Foundation {
        namespace Containers {
            ...
            inline DataHyperRectangle<T, INDEXES...>::DataHyperRectangle ()
                : inherited (move (Concrete::DataHyperRectangle_Factory<T, INDEXES...>::mk ()))
            {
                _AssertRepValidType ();
            }
            template <typename T, typename... INDEXES>
            ...
            bool DataHyperRectangle<T, INDEXES...>::Equals (const DataHyperRectangle<T, INDEXES...>& rhs) const
            {

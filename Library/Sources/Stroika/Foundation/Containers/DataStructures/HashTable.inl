...
namespace Stroika::Foundation::Containers::DataStructures {
    ...
    /*
     ********************************************************************************
     ************** HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Link_ ******************
     ********************************************************************************
     */
    ...
    constexpr HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Link_::Link_ (ArgByValueType<key_type> key, ArgByValueType<MAPPED_TYPE2> val)
        requires (not same_as<MAPPED_TYPE2, void>)
        : fEntry{key, val}
    {
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    constexpr HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Link_::Link_ (ArgByValueType<key_type> key)
...
#endif
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    constexpr HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Link_::Link_ (ArgByValueType<value_type> v)
        : fEntry{v}
    {
    }
     ...
     */
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::HashTable (const KeyComparerType& keyComparer)
        : fKeyThreeWayComparer_{keyComparer}
    {
        GrowHeadLinksIfNeeded_ (1, nullptr);
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::HashTable (const HashTable& src)
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::HashTable (HashTable&& src) noexcept
        : fKeyThreeWayComparer_{src.fKeyThreeWayComparer_}
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>& HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::operator= (const HashTable& t)
    {
        RemoveAll ();
        if (t.size () != 0) {
            Link_* prev = nullptr;
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    constexpr auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::key_comp () const -> KeyComparerType
    {
        return fKeyThreeWayComparer_;
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline size_t HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::GetLinkHeightProbability ()
    {
        return 25;
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::GetStats () const -> StatsType
    {
        return fStats_;
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::begin () const -> ForwardIterator
    {
        AssertExternallySynchronizedMutex::ReadContext declareContext{*this};
        return ForwardIterator{this};
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    constexpr auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::end () const noexcept -> ForwardIterator
    {
        return ForwardIterator{};
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    ...
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::FindLink_ (const KEYISH_T& key) const -> Link_*
    {
        using Common::ToInt;
        AssertExternallySynchronizedMutex::ReadContext declareContext{*this};
        ...
        for (size_t linkHeight = fHead_.size (); linkHeight > 0; --linkHeight) {
            ...
            while (n != overShotLink) {
                if constexpr (same_as<HashTable_Support::Stats_Basic, StatsType>) {
                    ++fStats_.fCompares;
                }
...
#endif
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::First (ArgByValueType<key_type> key) const -> optional<mapped_type>
    {
    ...
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::First (FUNCTION&& firstThat) const -> optional<mapped_type>
    {
        for (auto i : *this) {
            if (firstThat (*i)) {
                return i->fValue;
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
#if qCompilerAndStdLib_RequiresNotMatchInlineOutOfLineForTemplateClassBeingDefined_Buggy
    inline bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Add1_ (ArgByValueType<key_type> key, ForwardIterator* oAddedI)
#else
    inline bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Add (ArgByValueType<key_type> key, ForwardIterator* oAddedI)
        requires (same_as<mapped_type, void>)
#endif
    {
    ...
    inline bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Add2_ (ArgByValueType<key_type> key, ArgByValueType<CHECK_T> val, ForwardIterator* oAddedI)
#else
    template <typename CHECK_T>
    inline bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Add (ArgByValueType<key_type> key, ArgByValueType<CHECK_T> val, ForwardIterator* oAddedI)
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Add (const value_type& v, ForwardIterator* oAddedI)
    {
        return Add (v.fKey, v.fValue, oAddedI);
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::AddLink_ (Link_* link, const LinkVector_& links)
    {
        AssertExternallySynchronizedMutex::WriteContext declareContext{*this};
        RequireNotNull (link);
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Remove (ArgByValueType<key_type> key)
    {
        Verify (RemoveIf (key));
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Remove (const ForwardIterator& it)
    {
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::RemoveIf (ArgByValueType<key_type> key)
    {
        AssertExternallySynchronizedMutex::WriteContext declareContext{*this};
        if constexpr (TRAITS::kCostlyInvariants) {
            Invariant ();
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::RemoveLink_ (Link_* n, const LinkVector_& links)
    {
        AssertExternallySynchronizedMutex::WriteContext declareContext{*this};
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    size_t HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::DetermineLinkHeight_ () const
    {
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::GrowHeadLinksIfNeeded_ (size_t newSize, Link_* linkToPointTo)
    {
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ShrinkHeadLinksIfNeeded_ ()
    {
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::RemoveAll ()
    {
        AssertExternallySynchronizedMutex::WriteContext declareContext{*this};
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::FindNearest_ (const variant<key_type, ForwardIterator>& keyOrI) const -> LinkAndInfoAboutBackPointers
    {
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::GetFirst_ () const -> Link_*
    {
        Require (fHead_.size () >= 1);
        return fHead_[0];
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::GetLast_ () const -> Link_*
    {
        Require (fHead_.size () >= 1);
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Prioritize (ArgByValueType<key_type> key)
    {
        LinkAndInfoAboutBackPointers keyLinkInfo = FindNearest_ (key);
    ...
    inline void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::Update (const ForwardIterator& it, ArgByValueType<CHECKED_T> newValue)
        requires (not same_as<MAPPED_TYPE, void>)
    {
        const_cast<ForwardIterator&> (it).UpdateValue (newValue);
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ReBalance ()
    {
        if (empty ()) [[unlikely]] {
            return;
        }
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    size_t HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::CalcHeight (size_t* totalHeight) const
    {
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ForwardIterator::CurrentIndex (const HashTable* data) const -> size_t
    {
        Require (not Done ());
#if qStroika_Foundation_Debug_AssertionsChecked
        RequireNotNull (fData_);
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    inline constexpr bool HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ForwardIterator::operator== (const ForwardIterator& rhs) const
    {
#if qStroika_Foundation_Debug_AssertionsChecked
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ForwardIterator::operator++ () -> ForwardIterator&
    {
        fCurrent_ = fCurrent_->fNext[0];
        return *this;
    }
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    auto HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ForwardIterator::operator++ (int) -> ForwardIterator
    {
        ForwardIterator result = *this;
        this->operator++ ();
        return result;
    ...
    template <typename KEY_TYPE, typename MAPPED_TYPE, HashTable_Support::IValidTraits<KEY_TYPE> TRAITS>
    template <typename CHECKED_T>
    void HashTable<KEY_TYPE, MAPPED_TYPE, TRAITS>::ForwardIterator::UpdateValue (ArgByValueType<CHECKED_T> newValue)
        requires (not same_as<MAPPED_TYPE, void>)
    {

...
namespace   Stroika {
    namespace   Foundation {
        ...
        namespace Execution {
            ...
            template    <typename T, typename TRAITS>
            class   Synchronized<Containers::SortedSet<T, TRAITS>> {
            public:
                using   ContainerType =     Containers::SortedSet<T, TRAITS>;
            ...
            public:
                ...
                Synchronized (Containers::SortedSet<T, TRAITS>&& src) : fDelegate_ (move (src)) {}
            ...
            public:
                nonvirtual  operator Synchronized<Containers::SortedSet<T, TRAITS>> () const
                {
                    // need to lock
                    return fDelegate_;
                }
            private:
                Containers::SortedSet<T, TRAITS>    fDelegate_;
                mutex                               fLock_;
            };

...
namespace   Stroika {
    namespace   Foundation {
        namespace   Containers {
            ...
            protected:
                using   _SortedKeyedCollectionSharedPtrIRep  =   typename inherited::template SharedPtrImplementationTemplate<_IRep>;

            protected:
                using   _SharedPtrIRep  =   _SortedKeyedCollectionSharedPtrIRep;
            ...
            public:
                ...
                explicit SortedKeyedCollection (COPY_FROM_ITERATOR_OF_T start, COPY_FROM_ITERATOR_OF_T end);

...
namespace Stroika::Foundation::Containers {
    ...
    inline void Mapping<KEY_TYPE, MAPPED_VALUE_TYPE>::AddAll (CONTAINER_OF_KEYVALUE&& items)
    {
        /*
    ...
    {
        return typename Mapping<KEY_TYPE, MAPPED_VALUE_TYPE>::EqualsComparer{}(lhs, rhs);
    }
    template <typename KEY_TYPE, typename MAPPED_VALUE_TYPE>
    inline bool operator!= (const Mapping<KEY_TYPE, MAPPED_VALUE_TYPE>& lhs, const Mapping<KEY_TYPE, MAPPED_VALUE_TYPE>& rhs)
    {
        return not typename Mapping<KEY_TYPE, MAPPED_VALUE_TYPE>::EqualsComparer{}(lhs, rhs);
    }

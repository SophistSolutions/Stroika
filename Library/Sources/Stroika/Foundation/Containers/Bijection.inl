...
namespace Stroika::Foundation::Containers {
    ...
    inline Iterable<DOMAIN_TYPE> Bijection<DOMAIN_TYPE, RANGE_TYPE>::Preimage () const
    {
        ...
        return this->inherited::template Map5<Iterable<DOMAIN_TYPE>> ([] (const pair<DOMAIN_TYPE, RANGE_TYPE>& elt) { return elt.first; });
    }
    template <typename DOMAIN_TYPE, typename RANGE_TYPE>
    inline Iterable<RANGE_TYPE> Bijection<DOMAIN_TYPE, RANGE_TYPE>::Image () const
    {
        ...
        return this->inherited::template Map5<Iterable<RANGE_TYPE>> ([] (const pair<DOMAIN_TYPE, RANGE_TYPE>& elt) { return elt.second; });
    }
    template <typename DOMAIN_TYPE, typename RANGE_TYPE>

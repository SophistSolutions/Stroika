    ...
    namespace Foundation {
        namespace Containers {
            ...
            public:
                 ...
                 */
                using DomainEqualsCompareFunctionType = Common::FunctionComparerAdapter<function<bool(DomainType, DomainType)>, Common::ComparisonRelationType::eEquals>;
            ...
            public:
                 ...
                 *  we allow any template in the Set<> CTOR for an equalityComparer that follows the Common::IsEqualsComparer () concept (need better name).
                 */
                using RangeEqualsCompareFunctionType = Common::FunctionComparerAdapter<function<bool(RangeType, RangeType)>, Common::ComparisonRelationType::eEquals>;

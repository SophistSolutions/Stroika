...
namespace   Stroika {
    namespace   Foundation {
        ...
        namespace Execution {
            ...
            template    <typename DOMAIN_TYPE, typename RANGE_TYPE, typename TRAITS>
            class Synchronized<Containers::Bijection<DOMAIN_TYPE, RANGE_TYPE, TRAITS>> {
            public:
            ...
            public:
                ...
                Synchronized (Containers::Bijection<DOMAIN_TYPE, RANGE_TYPE, TRAITS>&& src) : fDelegate_ (move (src)) {}
                Synchronized (const initializer_list<pair<DOMAIN_TYPE, RANGE_TYPE>>& src) : fDelegate_ (src) {}
            ...
            public:
                nonvirtual  operator ContainerType () const
                {
                    // need to lock
                    return fDelegate_;
                }

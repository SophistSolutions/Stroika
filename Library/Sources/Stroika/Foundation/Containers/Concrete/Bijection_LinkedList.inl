        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                public:
                    ...
                    using   _SharedPtrIRep = Bijection<DOMAIN_TYPE, RANGE_TYPE, typename TRAITS::BijectionTraitsType>::_SharedPtrIRep;
                ...
                */
                ...
                Iterator<pair<DOMAIN_TYPE, RANGE_TYPE>>  Bijection_LinkedList<DOMAIN_TYPE, RANGE_TYPE, TRAITS>::Rep_::MakeIterator (IteratorOwnerID suggestedOwner) const
                {
                    ...
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        ...
                        tmpRep = typename Iterator<pair<DOMAIN_TYPE, RANGE_TYPE>>::SharedIRepPtr (new IteratorRep_ (suggestedOwner, &NON_CONST_THIS->fData_, NON_CONST_THIS->shared_from_this ()));
#else
                        tmpRep = typename Iterator<pair<DOMAIN_TYPE, RANGE_TYPE>>::SharedIRepPtr (new IteratorRep_ (suggestedOwner, &NON_CONST_THIS->fData_));
#endif
                    }
                    CONTAINER_LOCK_HELPER_END ();

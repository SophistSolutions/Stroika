        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                typename SortedSet_stdset<T, TRAITS>::Rep_::_IterableSharedPtrIRep  SortedSet_stdset<T, TRAITS>::Rep_::Clone (IteratorOwnerID forIterableEnvelope) const
                {
                ...
                template    <typename T, typename TRAITS>
                typename SortedSet_stdset<T, TRAITS>::Rep_::_SetSharedPtrIRep  SortedSet_stdset<T, TRAITS>::Rep_::CloneEmpty (IteratorOwnerID forIterableEnvelope) const
                {
                    if (fData_.HasActiveIterators ()) {
                        ...
                        return _SetSharedPtrIRep (new Rep_ ());
                    }
                }
                template    <typename T, typename TRAITS>

        ...
        namespace Containers {
            namespace Concrete {
                ...
                public:
                    ...
                    template <typename CONTAINER_OF_T, enable_if_t<Configuration::has_beginend<CONTAINER_OF_T>::value and !is_convertible_v<const CONTAINER_OF_T*, const Queue_Array<T>*>>* = nullptr>

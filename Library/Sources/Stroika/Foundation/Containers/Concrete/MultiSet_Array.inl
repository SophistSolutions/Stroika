    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                template    <typename T, typename TRAITS>
                bool    MultiSet_Array<T, TRAITS>::Rep_::Contains (PassTArgByValueType item) const
                {
                ...
                template    <typename T, typename TRAITS>
                void    MultiSet_Array<T, TRAITS>::Rep_::Add (PassTArgByValueType item, size_t count)
                {
                ...
                template    <typename T, typename TRAITS>
                void    MultiSet_Array<T, TRAITS>::Rep_::Remove (PassTArgByValueType item, size_t count)
                {
                    MultiSetEntry<T> tmp (item);
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        size_t index = Find_ (tmp);
                ...
                template    <typename T, typename TRAITS>
                size_t  MultiSet_Array<T, TRAITS>::Rep_::OccurrencesOf (PassTArgByValueType item) const
                {
                    MultiSetEntry<T> tmp (item);
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        size_t index = Find_ (tmp);

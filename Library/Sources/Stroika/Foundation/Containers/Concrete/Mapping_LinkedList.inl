    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                /*
                 ********************************************************************************
                 ******* Mapping_LinkedList<KEY_TYPE, VALUE_TYPE, TRAITS>::UpdateSafeIterationContainerRep_*****
                 ********************************************************************************
                 */
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                class   Mapping_LinkedList<KEY_TYPE, VALUE_TYPE, TRAITS>::UpdateSafeIterationContainerRep_ : public Mapping<KEY_TYPE, VALUE_TYPE, typename TRAITS::MappingTraitsType>::_IRep {
                private:
                 ...
                 */
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                inline  Mapping_LinkedList<KEY_TYPE, VALUE_TYPE, TRAITS>::Mapping_LinkedList ()

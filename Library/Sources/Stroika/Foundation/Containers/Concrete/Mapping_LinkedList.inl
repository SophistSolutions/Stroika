    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                template    <typename Key, typename T>
                Mapping_LinkedList<Key, T>::IteratorRep_::IteratorRep_ (typename Mapping_LinkedList<Key, T>::Rep_& owner)
                    : Iterator<pair<Key, T>>::IRep ()
                                          , fIterator_ (owner.fData_)
                {
                }
                template    <typename Key, typename T>
                bool    Mapping_LinkedList<Key, T>::IteratorRep_::More (pair<Key, T>* current, bool advance)
                {
                    return (fIterator_.More (current, advance));
                }
                template    <typename Key, typename T>
                bool    Mapping_LinkedList<Key, T>::IteratorRep_::StrongEquals (const typename Iterator<pair<Key, T>>::IRep* rhs) const
                {
                    AssertNotImplemented ();
                    return false;
                }
                template    <typename Key, typename T>
                shared_ptr<typename Iterator<pair<Key, T>>::IRep>  Mapping_LinkedList<Key, T>::IteratorRep_::Clone () const
                {

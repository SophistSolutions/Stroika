...
namespace Stroika::Foundation::Containers::Concrete {
    ...
    public:
        ...
        template <IIterable<CountedValue<T>> ITERABLE_OF_ADDABLE, enable_if_t<not is_base_of_v<MultiSet_stdmap<T, TRAITS>, remove_cvref_t<ITERABLE_OF_ADDABLE>>>* = nullptr>

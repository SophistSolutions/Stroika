                ...
                */
                ...
                Iterator<T>  SortedCollection_LinkedList<T, TRAITS>::Rep_::MakeIterator (IteratorOwnerID suggestedOwner) const
                {
                    ...
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        ...
                        tmpRep = typename Iterator<T>::SharedIRepPtr (Iterator<T>::MakeSharedPtr<IteratorRep_> (suggestedOwner, &NON_CONST_THIS->fData_, NON_CONST_THIS->shared_from_this ()));
#else
                        tmpRep = typename Iterator<T>::SharedIRepPtr (Iterator<T>::MakeSharedPtr<IteratorRep_> (suggestedOwner, &NON_CONST_THIS->fData_));
#endif
                    }
                    CONTAINER_LOCK_HELPER_END ();

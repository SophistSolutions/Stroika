        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                inline  Sequence_DoublyLinkedList<T, TRAITS>::Rep_::Rep_ (Rep_* from, IteratorOwnerID forIterableEnvelope)
                    : inherited ()
                ...
                template    <typename T, typename TRAITS>
                typename Iterable<T>::_SharedPtrIRep  Sequence_DoublyLinkedList<T, TRAITS>::Rep_::Clone (IteratorOwnerID forIterableEnvelope) const
                {
                ...
                template    <typename T, typename TRAITS>
                Iterator<T>  Sequence_DoublyLinkedList<T, TRAITS>::Rep_::MakeIterator (IteratorOwnerID suggestedOwner) const
                {
                ...
                template    <typename T, typename TRAITS>
                void      Sequence_DoublyLinkedList<T, TRAITS>::Rep_::Apply (_APPLY_ARGTYPE doToElement) const
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                ...
                template    <typename T, typename TRAITS>
                Iterator<T>     Sequence_DoublyLinkedList<T, TRAITS>::Rep_::ApplyUntilTrue (_APPLYUNTIL_ARGTYPE doToElement, IteratorOwnerID suggestedOwner) const
                {
...
#if     qDebug
                template    <typename T, typename TRAITS>
                void    Sequence_DoublyLinkedList<T, TRAITS>::Rep_::AssertNoIteratorsReferenceOwner (IteratorOwnerID oBeingDeleted)
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {

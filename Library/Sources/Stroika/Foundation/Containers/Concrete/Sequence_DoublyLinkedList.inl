        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T>
                void    Sequence_DoublyLinkedList<T>::Rep_::SetAt (size_t i, ArgByValueType<T> item)
                {
                    Require (i < GetLength ());
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        fData_.SetAt (i, item);
                ...
                template    <typename T>
                void    Sequence_DoublyLinkedList<T>::Rep_::Update (const Iterator<T>& i, ArgByValueType<T> newValue)
                {
                    const typename Iterator<T>::IRep&    ir  =   i.GetRep ();
                    AssertMember (&ir, IteratorRep_);
                    auto&       mir =   dynamic_cast<const IteratorRep_&> (ir);
                ...
                */
                template    <typename T>
                Sequence_DoublyLinkedList<T>::Sequence_DoublyLinkedList (ContainerUpdateIteratorSafety containerUpdateSafetyPolicy)

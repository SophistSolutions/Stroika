        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T>
                typename Iterable<T>::_SharedPtrIRep  Sequence_DoublyLinkedList<T>::Rep_::Clone (IteratorOwnerID forIterableEnvelope) const
                {
...
#if     qDebug
                template    <typename T>
                void    Sequence_DoublyLinkedList<T>::Rep_::AssertNoIteratorsReferenceOwner (IteratorOwnerID oBeingDeleted)
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {

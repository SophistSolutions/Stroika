        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                inline  Sequence_DoublyLinkedList<T, TRAITS>::Rep_::Rep_ (const Rep_& from, IteratorOwnerID forIterableEnvelope)
                    : inherited ()
                    , fLockSupport_ ()
                    , fData_ ()
                {
                ...
                template    <typename T, typename TRAITS>
                Iterator<T>     Sequence_DoublyLinkedList<T, TRAITS>::Rep_::ApplyUntilTrue (_APPLYUNTIL_ARGTYPE doToElement) const
                {

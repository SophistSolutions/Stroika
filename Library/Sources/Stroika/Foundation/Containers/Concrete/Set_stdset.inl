        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                typename Set_stdset<T, TRAITS>::Rep_::_SharedPtrIRep  Set_stdset<T, TRAITS>::Rep_::Clone (IteratorOwnerID forIterableEnvelope) const
                {
                ...
                template    <typename T, typename TRAITS>
                Iterator<T>     Set_stdset<T, TRAITS>::Rep_::ApplyUntilTrue (_APPLYUNTIL_ARGTYPE doToElement, IteratorOwnerID suggestedOwner) const
                {
...
#if     qDebug
                template    <typename T, typename TRAITS>
                void    Set_stdset<T, TRAITS>::Rep_::AssertNoIteratorsReferenceOwner (IteratorOwnerID oBeingDeleted)
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {

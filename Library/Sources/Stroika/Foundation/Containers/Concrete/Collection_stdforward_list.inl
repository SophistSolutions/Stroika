        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                bool    Collection_stdforward_list<T, TRAITS>::Rep_::Equals (const typename Collection<T, TRAITS>::_IRep& rhs) const
                {
                    return this->_Equals_Reference_Implementation (rhs);
                }
                template    <typename T, typename TRAITS>
                bool    Collection_stdforward_list<T, TRAITS>::Rep_::Contains (T item) const
                {
                    CONTAINER_LOCK_HELPER_START (fLockSupport_) {
                ...
                template    <typename T, typename TRAITS>
                size_t    Collection_stdforward_list<T, TRAITS>::Rep_::TallyOf (T item) const
                {

        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                private:
                    ...
                    friend  class Sequence_LinkedList<T, TRAITS>::IteratorRep_;
                };


                template    <typename T, typename TRAITS>
                class  Sequence_LinkedList<T, TRAITS>::IteratorRep_ : public Iterator<T>::IRep {
                private:
                    typedef typename    Iterator<T>::IRep   inherited;

                public:
                    explicit IteratorRep_ (typename Sequence_LinkedList<T, TRAITS>::Rep_& owner)
                        : inherited ()
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                Iterator<T>  Sequence_LinkedList<T, TRAITS>::Rep_::MakeIterator () const
                {
                ...
                template    <typename T, typename TRAITS>
                void      Sequence_LinkedList<T, TRAITS>::Rep_::Apply (typename Rep_::_APPLY_ARGTYPE doToElement) const
                {
                    this->_Apply (doToElement);
                }
                template    <typename T, typename TRAITS>
                Iterator<T>     Sequence_LinkedList<T, TRAITS>::Rep_::ApplyUntilTrue (typename Rep_::_APPLYUNTIL_ARGTYPE doToElement) const
                {
                ...
                size_t    Sequence_LinkedList<T, TRAITS>::Rep_::IndexOf (const Iterator<T>& i) const
                {
                    ...
                    const typename Sequence_LinkedList<T, TRAITS>::IteratorRep_&       mir =   dynamic_cast<const typename Sequence_LinkedList<T, TRAITS>::IteratorRep_&> (ir);
                    CONTAINER_LOCK_HELPER_START (fLockSupport_) {
                ...
                void    Sequence_LinkedList<T, TRAITS>::Rep_::Insert (size_t at, const T* from, const T* to)
                {
                    ...
                    CONTAINER_LOCK_HELPER_START (fLockSupport_) {
                        ...
                        if (at == 0) {
                            ...
                            size_t index = at;
                            T tmphack;
                            for (typename Private::PatchingDataStructures::LinkedList<T>::ForwardIterator it (fData_); it.More (&tmphack, true); ) {
                                if (--index == 0) {
                                    for (const T* p = from; p != to; ++p) {

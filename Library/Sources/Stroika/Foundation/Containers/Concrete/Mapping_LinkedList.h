    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                /**
                 *  \brief   Mapping_LinkedList<KEY_TYPE, VALUE_TYPE, TRAITS> is an LinkedList-based concrete implementation of the Mapping<KEY_TYPE, VALUE_TYPE, TRAITS> container pattern.
                 *

        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T, typename TRAITS>
                inline  Sequence_stdvector<T, TRAITS>::Rep_::Rep_ (Rep_* from, IteratorOwnerID forIterableEnvelope)
                    : inherited ()
                ...
                template    <typename T, typename TRAITS>
                Iterator<T>     Sequence_stdvector<T, TRAITS>::Rep_::ApplyUntilTrue (_APPLYUNTIL_ARGTYPE doToElement, IteratorOwnerID suggestedOwner) const
                {

...
namespace Stroika::Foundation::Containers::Concrete {
    ...
    public:
        ...
        template <ranges::range ITERABLE_OF_ADDABLE, enable_if_t<not is_base_of_v<Bijection_LinkedList<DOMAIN_TYPE, RANGE_TYPE>, decay_t<ITERABLE_OF_ADDABLE>>>* = nullptr>

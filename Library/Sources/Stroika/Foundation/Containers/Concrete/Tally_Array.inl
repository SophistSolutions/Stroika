    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                template    <typename T>
                shared_ptr<typename Iterable<T>::_IRep>    Tally_Array<T>::Rep_::Clone () const
                {
                ...
                template    <typename T>
                shared_ptr<typename Iterator<TallyEntry<T> >::IRep> Tally_Array<T>::Rep_::MakeTallyIterator () const
                {

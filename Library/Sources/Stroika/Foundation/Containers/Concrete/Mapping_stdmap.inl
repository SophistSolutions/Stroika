        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                typename Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::_IterableSharedPtrIRep  Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::Clone (IteratorOwnerID forIterableEnvelope) const
                {
                ...
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                typename Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::_SharedPtrIRep  Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::CloneEmpty (IteratorOwnerID forIterableEnvelope) const
                {
                ...
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                Iterable<VALUE_TYPE>    Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::Values () const
                {
                    return this->_Values_Reference_Implementation ();
                }
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                bool    Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::Lookup (ArgByValueType<KEY_TYPE> key, Memory::Optional<VALUE_TYPE>* item) const
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                ...
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                void    Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::Add (ArgByValueType<KEY_TYPE> key, ArgByValueType<VALUE_TYPE> newElt)
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        fData_.Invariant ();
                        auto i = fData_.find (key);
                ...
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                void    Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::Remove (ArgByValueType<KEY_TYPE> key)
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                        fData_.Invariant ();
                        auto i = fData_.find (key);
                ...
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                void    Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Rep_::Remove (const Iterator<KeyValuePair<KEY_TYPE, VALUE_TYPE>>& i)
                {
                ...
                */
                template    <typename KEY_TYPE, typename VALUE_TYPE, typename TRAITS>
                Mapping_stdmap<KEY_TYPE, VALUE_TYPE, TRAITS>::Mapping_stdmap (ContainerUpdateIteratorSafety containerUpdateSafetyPolicy)

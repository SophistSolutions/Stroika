        ...
        namespace   Containers {
            namespace   Concrete {
                ...
                */
                ...
                template    <typename T>
                typename Collection_Array<T>::Rep_::_SharedPtrIRep  Collection_Array<T>::Rep_::Clone () const
                {
                    // no lock needed cuz src locked in Rep_ CTOR
                    return _SharedPtrIRep (new Rep_ (*this));
                }
                template    <typename T>
                Iterator<T>  Collection_Array<T>::Rep_::MakeIterator (_IteratorOwnerID suggestedOwner) const
                {

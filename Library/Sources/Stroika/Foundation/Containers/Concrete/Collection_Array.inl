    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                private:
                    using   DataStructureImplType_  =   Private::PatchingDataStructures::Array <T, Private::DataStructures::Array_DefaultTraits<T, void>, Private::ContainerRepLockDataSupport_>;

    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                template    <typename T, typename TRAITS>
                bool   MultiSet_LinkedList<T, TRAITS>::Rep_::Contains (T item) const
                {
                    CONTAINER_LOCK_HELPER_START (fData_.fLockSupport) {
                ...
                template    <typename T, typename TRAITS>
                void   MultiSet_LinkedList<T, TRAITS>::Rep_::Add (T item, size_t count)
                {
                ...
                template    <typename T, typename TRAITS>
                void   MultiSet_LinkedList<T, TRAITS>::Rep_::Remove (T item, size_t count)
                {
                    using   Traversal::kUnknownIteratorOwnerID;
                    if (count != 0) {
                        MultiSetEntry<T>   current (item);

    ...
    namespace   Foundation {
        namespace   Containers {
            namespace   Concrete {
                ...
                inline  Mapping<KEY_TYPE, VALUE_TYPE, TRAITS>  Mapping_Factory<KEY_TYPE, VALUE_TYPE, TRAITS>::Default_SFINAE_ (typename enable_if <Configuration::has_lt<CHECK_KEY>::value>::type*)
                {

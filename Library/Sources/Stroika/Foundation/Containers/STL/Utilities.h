...
namespace Stroika::Foundation::Containers::STL {
     ...
     */
    template <typename ITERABLE_OF_T, typename T = typename ITERABLE_OF_T::value_type, typename EQUALS_COMPARER = equal_to<T>,
              enable_if_t<Common::IsPotentiallyComparerRelation<EQUALS_COMPARER, T> ()>* = nullptr>

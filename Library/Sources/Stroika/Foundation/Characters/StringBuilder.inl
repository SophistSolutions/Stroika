...
namespace Stroika::Foundation::Characters {
    ...
    {
        Debug::AssertExternallySynchronizedChecker::ReadContext declareContext{fAssertExternallySynchronized_};
    ...
    {
        Debug::AssertExternallySynchronizedChecker::WriteContext declareContext{fAssertExternallySynchronized_}; // doesn't do much good bit a little
        return fData_.data ();
    }
    template <typename OPTIONS>
    inline auto StringBuilder<OPTIONS>::data () const -> span<const BufferElementType>
    {
        Debug::AssertExternallySynchronizedChecker::ReadContext declareContext{fAssertExternallySynchronized_}; // doesn't do much good bit a little
        return fData_.data ();
    }
    template <typename OPTIONS>
    template <IUNICODECanUnambiguouslyConvertFrom CHAR_T>

...
#if !defined(_LIBCPP_VERSION) or _LIBCPP_VERSION > 209999
...
#if (not defined (_GLIBCXX_RELEASE) or _GLIBCXX_RELEASE > 12) and (!defined(_LIBCPP_VERSION) or _LIBCPP_VERSION > 209999)

...
namespace Stroika::Foundation::Characters {
    ...
    inline Common::strong_ordering String::ThreeWayComparer::operator() (const Character* lhs, const Stroika::Foundation::Characters::Character* rhs) const
    {
        return Cmp_ (lhs, rhs);
    }
    inline Common::strong_ordering String::ThreeWayComparer::operator() (const wchar_t* lhs, const Stroika::Foundation::Characters::String& rhs) const
    {
        return Cmp_ (lhs, rhs);
    }
    ...
    inline Common::strong_ordering String::ThreeWayComparer::operator() (const Stroika::Foundation::Characters::String& lhs, const wchar_t* rhs) const
    {
        return Cmp_ (lhs, rhs);
    }

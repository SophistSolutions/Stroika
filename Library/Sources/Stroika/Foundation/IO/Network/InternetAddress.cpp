        ...
        switch (af) {
            case AddressFamily::V4: {
                if (::inet_pton (AF_INET, s.c_str (), &fV4_) == 0) {
                    static const auto kException_{Execution::Exception<runtime_error>{"unable to parse string as IPv4 internet address"sv}};
            ...
            case AddressFamily::V6: {
                if (::inet_pton (AF_INET6, s.c_str (), &fV6_) == 0) {
                    static const auto kException_{Execution::Exception<runtime_error>{"unable to parse string as IPv6 internet address"sv}};
                    Execution::Throw (kException_);
                }
                fAddressFamily_ = af;
            } break;
            default: {
                ...
                static const auto kException_{Execution::Exception<runtime_error>{"Unrecognized address family"sv}};
                Execution::Throw (kException_);
            } break;
        }
    }
...
/*
 ********************************************************************************
 ******** DataExchange::DefaultSerializer<IO::Network::InternetAddress> *********
 ********************************************************************************
 */
Memory::BLOB DataExchange::DefaultSerializer<IO::Network::InternetAddress>::operator() (const IO::Network::InternetAddress& arg) const
{

...
Request::Request ()
    : httpVersion{[qStroika_Foundation_Common_Property_ExtraCaptureStuff] ([[maybe_unused]] const auto* property) -> String {
                      ...
                      Debug::AssertExternallySynchronizedChecker::ReadContext declareContext{thisObj->_fThisAssertExternallySynchronized};
    ...
    , httpMethod{[qStroika_Foundation_Common_Property_ExtraCaptureStuff] ([[maybe_unused]] const auto* property) {
                 ...
                 [qStroika_Foundation_Common_Property_ExtraCaptureStuff] ([[maybe_unused]] auto* property, const auto& method) {
                     ...
                     Debug::AssertExternallySynchronizedChecker::WriteContext declareContext{thisObj->_fThisAssertExternallySynchronized};
    ...
    , rwHeaders{[qStroika_Foundation_Common_Property_ExtraCaptureStuff] ([[maybe_unused]] const auto* property) -> IO::Network::HTTP::Headers& {
                    ...
                    AssertExternallySynchronizedChecker::WriteContext declareContext{thisObj->_fThisAssertExternallySynchronized}; // not shared_lock cuz rw
                    return thisObj->fHeaders_;
                },
...
void Request::SetAssertExternallySynchronizedCheckerContext (const shared_ptr<Debug::AssertExternallySynchronizedChecker::SharedContext>& sharedContext)
{

...
using namespace Stroika::Foundation::IO::Network::HTTP::MessageStartTextInputStreamBinaryAdapter;
...
namespace {
    ...
    class Rep_ final : public InputStream::IRep<Character> {
    ...
    protected:
        ...
        virtual optional<span<Character>> Read (span<Character> intoBuffer, NoDataAvailableHandling blockFlag) override
        {
            ...
            if (fBufferFilledUpValidBytes_ == fOffset_) {
                ...
                size_t n           = fSource_.ReadOrThrow (span{startReadAt, roomLeftInBuf}, blockFlag).size ();

...
namespace Stroika::Foundation::IO::Network {
    ...
    namespace ConnectionOrientedStreamSocket {
        ...
        public:
            /**
             *  Automatically call Shutdown () when closing socket, and Wait this number of seconds to receive the
        ...
        public:
            ...
            virtual span<byte>           Read (span<byte> into) const                                                           = 0;
            virtual optional<span<byte>> ReadNonBlocking (span<byte> into) const                                                = 0;
            virtual optional<size_t>     AvailableToRead () const                                                               = 0;
         ...
         *          auto fromStrm = TextToBinary::Writer::New (SocketStream::New (fromRawSocket));
         *          auto toStrm   = BinaryToText::Reader::New (SocketStream::New (toRawSocket));

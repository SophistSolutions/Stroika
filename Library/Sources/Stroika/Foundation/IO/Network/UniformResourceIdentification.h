...
namespace Stroika::Foundation::IO::Network::UniformResourceIdentification {
     ...
     *        in the As<> method.
     * 
     *  \note - SEE https://github.com/SophistSolutions/Stroika/issues/1132 (STK-1000) -- issue about maybe needed more nuanced approach
    ...
    public:
         ...
         * 
         *  \todo https://github.com/SophistSolutions/Stroika/issues/884 (STK-750)
     ...
     *          @todo see https://github.com/SophistSolutions/Stroika/issues/279 (STK-144) and fix when that is fixed
     *

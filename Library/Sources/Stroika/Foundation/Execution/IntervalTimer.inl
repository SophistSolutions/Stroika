...
namespace Stroika::Foundation::Execution {
    ...
    inline void IntervalTimer::Manager ::AddRepeating (const TimerCallback& intervalTimer, const Time::Duration& repeatInterval, const optional<Time::Duration>& histeresis)
    {
     ...
     ********************************************************************************
     */
    inline IntervalTimer::Adder::Adder (IntervalTimer::Manager& manager, const Function<void (void)>& f, const Time::Duration& repeatInterval, const optional<Time::Duration>& histeresis)
        : fManager_{manager}
        , fFunction_{f}
    {
        Manager::sThe.AddRepeating (fFunction_, repeatInterval, histeresis);
    }
    inline IntervalTimer::Adder::Adder (const Function<void (void)>& f, const Time::Duration& repeatInterval, const optional<Time::Duration>& histeresis)
        : Adder{Manager::sThe, f, repeatInterval, histeresis}
    {
    }

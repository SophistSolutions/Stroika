...
namespace Stroika::Foundation::Execution::Platform::Windows {
    ...
    inline CriticalSectionRecursiveMutex::~CriticalSectionRecursiveMutex () { ::DeleteCriticalSection (&fCritSec_); }
    inline void CriticalSectionRecursiveMutex::lock () { ::EnterCriticalSection (&fCritSec_); }
    inline void CriticalSectionRecursiveMutex::unlock () { ::LeaveCriticalSection (&fCritSec_); }

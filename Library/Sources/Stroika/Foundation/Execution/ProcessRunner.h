...
namespace Stroika::Foundation::Execution {
    ...
    /**
     *  Exceptions generated by ProcessRunner are typically of this sort.
     */
    class ProcessRunner::Exception : public Execution::Exception<runtime_error> {
    private:
    ...
    public:
        /**
         */
        Exception (const String& failureMessage, const optional<String>& stderrFragment = nullopt,
                   const optional<ExitStatusType>& wExitStatus = nullopt, const optional<SignalID>& wTermSig = nullopt);

    public:
        /**
         *  High level summary - not including stuff like exit status, stderr results etc
         */
        const String fFailureMessage;

    public:
        const optional<String> fStderrFragment;

    public:
        const optional<ExitStatusType> fExitStatus;

    public:
        const optional<SignalID> fTermSignal;

    private:
        static String mkMsg_ (const String& errorMessage, const optional<String>& stderrSubset, const optional<ExitStatusType>& wExitStatus,

...
namespace   Stroika {
    namespace   Foundation {
        namespace   Execution {
            ...
            /**
             *  Normal mutexes are not copyable. But sometimes its handy to be able to expose a mutex to a
             *  number of different peices of code, those other peices of code must be told what mutex to share.
             *

        ...
        namespace Math {
            namespace Optimization {
                namespace DownhillSimplexMinimization {
                    ...
                    template <typename FLOAT_TYPE>
                    struct Results {
#if qCompilerAndStdLib_autogenerated_CTOR_from_default_initial_values_used_with_initializer_Buggy
                        Results (MinimizationParametersType<FLOAT_TYPE> op = MinimizationParametersType<FLOAT_TYPE>{}, FLOAT_TYPE score = {}, unsigned int itCnt = {})
                            : fOptimizedParameters (op)
                            , fScore (score)
                            , fIterationCount (itCnt)
                        {
                        }
#endif

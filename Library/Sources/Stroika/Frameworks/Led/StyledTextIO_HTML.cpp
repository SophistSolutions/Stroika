...
void	StyledTextIOReader_HTML::HandleHTMLThingy_Tag (const char* text, size_t nBytes)
{
	...
	if (0) 											{}
	else if (::strcmp (tagBuf, "!doctype") == 0) 	{	HandleHTMLThingyTag_BANG_doctype (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "a") == 0) 			{	HandleHTMLThingyTag_a (isStartTag, text, nBytes);				}
	else if (::strcmp (tagBuf, "b") == 0) 			{	HandleHTMLThingyTag_b (isStartTag, text, nBytes);				}
	else if (::strcmp (tagBuf, "basefont") == 0) 	{	HandleHTMLThingyTag_basefont (isStartTag, text, nBytes);		}
	else if (::strcmp (tagBuf, "blockquote") == 0) 	{	HandleHTMLThingyTag_blockquote (isStartTag, text, nBytes);		}
	else if (::strcmp (tagBuf, "br") == 0) 			{	HandleHTMLThingyTag_br (isStartTag, text, nBytes);				}
	else if (::strcmp (tagBuf, "body") == 0) 		{	HandleHTMLThingyTag_body (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "code") == 0) 		{	HandleHTMLThingyTag_code (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "comment") == 0) 	{	HandleHTMLThingyTag_comment (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "dir") == 0) 		{	HandleHTMLThingyTag_dir (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "div") == 0) 		{	HandleHTMLThingyTag_div (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "em") == 0) 			{	HandleHTMLThingyTag_em (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "font") == 0) 		{	HandleHTMLThingyTag_font (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "head") == 0) 		{	HandleHTMLThingyTag_head (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "html") == 0) 		{	HandleHTMLThingyTag_html (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "hr") == 0) 			{	HandleHTMLThingyTag_hr (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h1") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h2") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h3") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h4") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h5") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h6") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h7") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h8") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "h9") == 0) 			{	HandleHTMLThingyTag_hN (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "i") == 0) 			{	HandleHTMLThingyTag_i (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "img") == 0) 		{	HandleHTMLThingyTag_img (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "li") == 0)			{	HandleHTMLThingyTag_li (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "listing") == 0)		{	HandleHTMLThingyTag_listing (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "ol") == 0)			{	HandleHTMLThingyTag_ol (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "p") == 0) 			{	HandleHTMLThingyTag_p (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "plaintext") == 0)	{	HandleHTMLThingyTag_plaintext (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "pre") == 0) 		{	HandleHTMLThingyTag_pre (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "s") == 0)			{	HandleHTMLThingyTag_s (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "samp") == 0)		{	HandleHTMLThingyTag_samp (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "small") == 0)		{	HandleHTMLThingyTag_small (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "span") == 0)		{	HandleHTMLThingyTag_span (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "strike") == 0)		{	HandleHTMLThingyTag_strike (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "strong") == 0)		{	HandleHTMLThingyTag_strong (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "sub") == 0)			{	HandleHTMLThingyTag_sub (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "sup") == 0)			{	HandleHTMLThingyTag_sup (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "table") == 0)		{	HandleHTMLThingyTag_table (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "td") == 0)			{	HandleHTMLThingyTag_td (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "th") == 0)			{	HandleHTMLThingyTag_th (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "title") == 0)		{	HandleHTMLThingyTag_title (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "tr") == 0)			{	HandleHTMLThingyTag_tr (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "tt") == 0)			{	HandleHTMLThingyTag_tt (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "u") == 0)			{	HandleHTMLThingyTag_u (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "ul") == 0)			{	HandleHTMLThingyTag_ul (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "var") == 0)			{	HandleHTMLThingyTag_var (isStartTag, text, nBytes);	}
	else if (::strcmp (tagBuf, "xmp") == 0)			{	HandleHTMLThingyTag_xmp (isStartTag, text, nBytes);	}
	...
	if (start) {
		...
		if (start) {
			...
			if (nBytes > 3 and isdigit (text[2])) {
				...
				switch (headingLevel) {
					case	1:	SetHTMLFontSize (7);	break;
					case	2:	SetHTMLFontSize (6);	break;
					case	3:	SetHTMLFontSize (5);	break;
					case	4:	SetHTMLFontSize (4);	break;
					case	5:	SetHTMLFontSize (3);	break;
					default: {
						// ingored
					}
				}
...
bool	StyledTextIOReader_HTML::ParseHTMLTagArgOut (const string& tagText, const string& attrName, string* attrValue)
{
	...
	if (i == 0 and tagText[i] == '<')			{	++i;	}		// SKIP leading <
	while (i < len and isspace (tagText[i]))	{	++i;	}		// SKIP WHITESPACE
...
bool	StyledTextIOReader_HTML::ParseCSSTagArgOut (const string& text, const string& attrName, string* attrValue)
{
	...
	for (size_t i = 0; i < len; i++) {
		while (i < len and isspace (text[i]) or (text[i]==';'))	{	++i;	}			// SKIP WHITESPACE (or semi-colon - attribute separator)
		...
		while (i < len and isspace (text[i]))	{	++i;	}			// SKIP WHITESPACE
...
void	StyledTextIOWriter_HTML::Write ()
{
	...
	WriteCloseTag (writerContext, "html"); write ("\r\n");
}
...
void	StyledTextIOWriter_HTML::WriteBodyCharacter (WriterContext& writerContext, Led_tChar c)
{
	...
	if (not writerContext.fEmittedStartOfPara and (not writerContext.fEmittingListItem) and (not writerContext.fInTableCell)) {
		...
		switch (writerContext.GetSrcStream ().GetJustification ()) {
			case	eLeftJustify:	WriteOpenTag (writerContext, "p", "align=\"left\"");	break;
			case	eCenterJustify:	WriteOpenTag (writerContext, "p", "align=\"center\"");	break;
			case	eRightJustify:	WriteOpenTag (writerContext, "p", "align=\"right\"");	break;
			case	eFullyJustify:	WriteOpenTag (writerContext, "p", "align=\"justify\"");break;
...
void	StyledTextIOWriter_HTML::WriteTable (WriterContext& writerContext, Table* table)
{
	...
	WriteOpenTag (writerContext, "table");write ("\r\n");
	...
	for (size_t r = 0; r < rows; ++r) {
		...
		WriteCloseTag (writerContext, "tr");write ("\r\n");
	}

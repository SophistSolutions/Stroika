...
vector<Led_tChar> SpellCheckEngine_Basic::EditableDictionary::SaveToBuffer () const
{
    ...
    const Led_tChar kLineTerm[] = LED_TCHAR_OF ("\n");
#endif
    const size_t kLineTerm_Length  = std::size (kLineTerm) - 1;
...
void SpellCheckEngine_Basic_Simple::WriteToUD ()
{
    ...
    Streams::TextToBinary::Writer::New (writer, UnicodeExternalEncodings::eUTF8, ByteOrderMark::eInclude).Write (span{data});
}

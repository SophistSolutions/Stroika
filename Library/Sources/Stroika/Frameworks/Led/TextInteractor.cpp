...
bool    TextInteractor::OnUpdateCommand (CommandUpdater* enabler)
{
    ...
    switch (enabler->GetCmdID ()) {
        ...
        case    kCut_CmdID:
            {   OnUpdateCutCopyClearCommand (enabler);      return true;    }
        case    kCopy_CmdID:
            {   OnUpdateCutCopyClearCommand (enabler);      return true;    }
        case    kPaste_CmdID:
            {   OnUpdatePasteCommand (enabler);             return true;    }
        case    kClear_CmdID:
            {   OnUpdateCutCopyClearCommand (enabler);      return true;    }
        case    kUndo_CmdID:
            {   OnUpdateUndoRedoCommand (enabler);          return true;    }
        case    kRedo_CmdID:
            {   OnUpdateUndoRedoCommand (enabler);          return true;    }
        case    kFind_CmdID:
            {   OnUpdateFindCommands (enabler);             return true;    }
        ...
        case    kSpellCheck_CmdID:
            {   OnUpdateSpellCheckCommand (enabler);        return true;    }
        case    kSelectWord_CmdID:
        case    kSelectTextRow_CmdID:
        case    kSelectParagraph_CmdID:
            {   OnUpdateSelectTextCommand (enabler);        return true;    }
    }
    return false;
}
...
bool    TextInteractor::OnPerformCommand (CommandNumber commandNumber)
{
    switch (commandNumber) {
        ...
        case    kCopy_CmdID:
            {   OnCopyCommand ();           return true;    }
        case    kPaste_CmdID:
            {   OnPasteCommand ();          return true;    }
        case    kClear_CmdID:
            {   OnClearCommand ();          return true;    }
        case    kUndo_CmdID:
            {   OnUndoCommand ();           return true;    }
        case    kRedo_CmdID:
            {   OnRedoCommand ();           return true;    }
        case    kFind_CmdID:
            {   OnFindCommand ();           return true;    }
        case    kFindAgain_CmdID:
            {   OnFindAgainCommand ();      return true;    }
        case    kEnterFindString_CmdID:
            {   OnEnterFindString ();       return true;    }
        case    kReplace_CmdID:
            {   OnReplaceCommand ();        return true;    }
        case    kReplaceAgain_CmdID:
            {   OnReplaceAgainCommand ();   return true;    }
        case    kSpellCheck_CmdID:
            {   OnSpellCheckCommand ();     return true;    }
        case    kSelectWord_CmdID:
        case    kSelectTextRow_CmdID:
        case    kSelectParagraph_CmdID:
            {   OnPerformSelectTextCommand (commandNumber); return true;    }
    }
    return false;
}

...
void WordProcessor::OnInsertURLCommand ()
{
    ...
    if (GetDialogSupport ().ShowAddURLEmbeddingInfoDialog (&title, &url)) {
        ...
        {
            SimpleEmbeddedObjectStyleMarker* e = new StandardURLStyleMarker{
                Led_URLD{String::FromSDKString (url).AsNarrowSDKString ().c_str (), String::FromSDKString (title).AsNarrowSDKString ().c_str ()}};

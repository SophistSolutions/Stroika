...
Instrument& Instrument::operator= (Instrument&& rhs) noexcept
{
    ...
    AssertExternallySynchronizedChecker::WriteContext declareWriteContext2{rhs.fThisAssertExternallySynchronized_};
...
{
    AssertExternallySynchronizedChecker::WriteContext declareContext{fThisAssertExternallySynchronized_};
    AssertExternallySynchronizedChecker::ReadContext  readLock{rhs.fThisAssertExternallySynchronized_};

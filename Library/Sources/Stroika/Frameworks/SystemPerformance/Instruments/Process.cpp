...
ObjectVariantMapper Instruments::Process::GetObjectVariantMapper ()
{
    ...
    static  const   ObjectVariantMapper sMapper_ = [] () -> ObjectVariantMapper {
        ...
        mapper.AddClass<ProcessType::TCPStats> (initializer_list<StructureFieldInfo> {
            { String_Constant (L"Established"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType::TCPStats, fEstablished) },
            { String_Constant (L"Listening"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType::TCPStats, fListening) },
            { String_Constant (L"Other"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType::TCPStats, fOther) },
        });
        mapper.AddCommonType<Optional<ProcessType::TCPStats>> ();
        mapper.AddClass<ProcessType> (initializer_list<StructureFieldInfo> {
            { String_Constant (L"Kernel-Process"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fKernelProcess), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Parent-Process-ID"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fParentProcessID), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Process-Name"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fProcessName), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"User-Name"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fUserName), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Command-Line"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCommandLine), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Current-Working-Directory"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCurrentWorkingDirectory), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Environment-Variables"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fEnvironmentVariables), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"EXE-Path"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fEXEPath), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Root"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fRoot), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Process-Started-At"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fProcessStartedAt), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Run-Status"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fRunStatus), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Private-Virtual-Memory-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPrivateVirtualMemorySize), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Total-Virtual-Memory-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fTotalVirtualMemorySize), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Resident-Memory-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fResidentMemorySize), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Private-Bytes"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPrivateBytes), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Page-Fault-Count"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPageFaultCount), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Major-Page-Fault-Count"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fMajorPageFaultCount), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Working-Set-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fWorkingSetSize), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Private-Working-Set-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPrivateWorkingSetSize), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Total-CPUTime-Ever-Used"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fTotalCPUTimeEverUsed), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Average-CPUTime-Used"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fAverageCPUTimeUsed), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Thread-Count"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fThreadCount), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Read-Rate"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOReadRate), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Write-Rate"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOWriteRate), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Read-Bytes"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOReadBytes), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Write-Bytes"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOWriteBytes), StructureFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"TCP-Stats"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fTCPStats), StructureFieldInfo::NullFieldHandling::eOmit },
        });

...
ObjectVariantMapper Instruments::Process::GetObjectVariantMapper ()
{
    ...
    static  const   ObjectVariantMapper sMapper_ = [] () -> ObjectVariantMapper {
        ...
        mapper.AddClass<ProcessType> (initializer_list<StructFieldInfo> {
            { String_Constant (L"Kernel-Process"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fKernelProcess), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Parent-Process-ID"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fParentProcessID), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Process-Name"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fProcessName), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"User-Name"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fUserName), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Command-Line"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCommandLine), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Current-Working-Directory"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCurrentWorkingDirectory), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Environment-Variables"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fEnvironmentVariables), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"EXE-Path"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fEXEPath), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Root"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fRoot), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Process-Started-At"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fProcessStartedAt), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Run-Status"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fRunStatus), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Private-Virtual-Memory-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPrivateVirtualMemorySize), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Total-Virtual-Memory-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fTotalVirtualMemorySize), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Resident-Memory-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fResidentMemorySize), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Private-Bytes"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPrivateBytes), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Page-Fault-Count"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPageFaultCount), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Major-Page-Fault-Count"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fMajorPageFaultCount), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Working-Set-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fWorkingSetSize), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Private-Working-Set-Size"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fPrivateWorkingSetSize), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Total-CPUTime-Ever-Used"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fTotalCPUTimeEverUsed), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Average-CPUTime-Used"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fAverageCPUTimeUsed), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Thread-Count"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fThreadCount), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Read-Rate"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOReadRate), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Write-Rate"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOWriteRate), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Read-Bytes"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOReadBytes), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"Combined-IO-Write-Bytes"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fCombinedIOWriteBytes), StructFieldInfo::NullFieldHandling::eOmit },
            { String_Constant (L"TCP-Stats"), Stroika_Foundation_DataExchange_StructFieldMetaInfo (ProcessType, fTCPStats), StructFieldInfo::NullFieldHandling::eOmit },
        });

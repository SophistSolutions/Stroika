...
namespace Stroika::Frameworks::SystemPerformance::Instruments::Filesystem {
    ...
    /**
     *  \todo This is NYI, for Linux (https://github.com/SophistSolutions/Stroika/issues/867 (STK-733))
     */
    struct DiskInfoType {
        /*
...
namespace Stroika::Frameworks::SystemPerformance {
     ...
     */
    template <>
    Instruments::Filesystem::Info Instrument::CaptureOneMeasurement (Range<TimePointSeconds>* outMeasuredAt);
}

...
namespace Stroika::Frameworks::SystemPerformance::Instruments::Process {
    ...
    struct ProcessType {
         ...
         *  TCP streams.
         *
         *  \note   @todo https://github.com/SophistSolutions/Stroika/issues/612 (STK-478)  - fTCPStats for whole computer not process
         */
        struct TCPStats {
...
namespace Stroika::Frameworks::SystemPerformance {
     ...
     */
    template <>
    Instruments::Process::Info Instrument::CaptureOneMeasurement (Range<TimePointSeconds>* outMeasuredAt);

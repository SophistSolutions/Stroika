...
namespace {
    struct FSRouterRep_ {
        ...
        void HandleMessage (Message* m)
        {
            ...
            Debug::TraceContextBumper ctx{Stroika_Foundation_Debug_OptionalizeTraceArgs (L"{}...FileSystemRequestHandler...HandleMessage", L"relURL=%s, serving fn=%s", Characters::ToString (m->PeekRequest ()->url ().GetAuthorityRelativeResource ()).c_str (), Characters::ToString (fn).c_str ())};
#endif
            try {

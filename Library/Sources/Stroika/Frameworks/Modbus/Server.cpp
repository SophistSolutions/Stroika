...
namespace {
                             ...
                             const ServerOptions& options)
    {
        ...
        OutputStream<byte>::Ptr out = BufferedOutputStream::New<byte> (socketStream); // critical so we don't write multiple packets - at least some apps assume whole thing comes in one packet

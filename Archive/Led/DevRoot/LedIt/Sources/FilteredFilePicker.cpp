...
/*
 * $Header: /cygdrive/k/CVSRoot/LedIt/Sources/FilteredFilePicker.cpp,v 1.12 2003/03/21 14:59:42 lewis Exp $
 *
 * Description:
 *
 *
 ...
 *	Revision 1.12  2003/03/21 14:59:42  lewis
 *	SPR#1368 - added CRTDBG_MAP_ALLOC_NEW support
 *	
 *	Revision 1.11  2003/03/14 00:57:30  lewis
 *	SPR#1341 - Set initial control value properly in FilteredSFPutDLog::NavEventProc () for kNavCBStart event
 *	
 *	Revision 1.10  2003/03/13 13:14:08  lewis
 *	pass back the replacing flag in NavServices PutFile dialog
 *	
 *	Revision 1.9  2003/03/13 02:36:01  lewis
 *	SPR#1337- bad prev checkin comment - REALLY added qUseNavServices support (and works at least basically on MacOSX
 *	
 *	Revision 1.8  2003/03/13 02:34:48  lewis
 *	SPR#1337 - I noted the indexes for the file formats where wrong in LedItApplication::ChooseDocument () MACONLY CODE
 *	
 *	Revision 1.7  2002/05/06 21:31:02  lewis
 *	<========================================= Led 3.0.1 Released ========================================>
 *	
 *	Revision 1.6  2001/11/27 00:28:11  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 1.5  2001/08/29 22:59:18  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.4  2001/07/19 21:05:31  lewis
 *	*** empty log message ***
 *	

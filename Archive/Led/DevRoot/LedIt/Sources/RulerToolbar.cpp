...
/*
 * $Header: /cygdrive/k/CVSRoot/LedIt/Sources/RulerToolbar.cpp,v 1.8 2003/03/21 15:02:03 lewis Exp $
 *
 * Description:
 *
 *
 ...
 *	Revision 1.8  2003/03/21 15:02:03  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.7  2002/10/30 22:44:03  lewis
 *	SPR#1158 - SetDefaultWindowMargins () API now uses Led_TWIPS
 *	
 *	Revision 1.6  2002/10/24 15:53:16  lewis
 *	SPR#0680- adjust the window margins so text looks a little better. Did for MacOS/XWin/Win -
 *	but only tested on Win so far
 *	
 *	Revision 1.5  2002/05/06 21:31:09  lewis
 *	<========================================= Led 3.0.1 Released ========================================>
 *	
 *	Revision 1.4  2001/11/27 00:28:16  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 1.3  2001/08/29 22:59:19  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.2  2001/07/31 15:47:35  lewis
 *	avoid some int/unsigned warnings
 *	
 *	Revision 1.1  2001/05/14 20:54:49  lewis

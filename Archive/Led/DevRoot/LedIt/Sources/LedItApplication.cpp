...
/*
 * $Header: /cygdrive/k/CVSRoot/LedIt/Sources/LedItApplication.cpp,v 1.61 2004/02/11 22:41:35 lewis Exp $
 *
 * Description:
 *
 *
 ...
 *	Revision 1.61  2004/02/11 22:41:35  lewis
 *	SPR#1576: update: added 'Replace Again' command to LedIt, LedLineItMFC, ActiveLedIt
 *	
 *	Revision 1.60  2004/02/11 01:12:07  lewis
 *	SPR#1635: lose TRACE calls (from cloned MFC code - no real point to it - and it didn't compile with MSVC60). Also define CSIDL_FLAG_CREATE if its not defiend (again - for MSVC60)
 *	
 *	Revision 1.59  2003/12/31 16:04:50  lewis
 *	SPR#1610: replace call to Win32 ::OpenFile with ::CreateFile (so works with UNICODE apps)
 *	
 *	Revision 1.58  2003/12/11 03:19:32  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.57  2003/12/09 21:05:00  lewis
 *	use new SpellCheckEngine_Basic_Simple class and call fSpellCheckEngine.SetUserDictionary to specify UD name
 *	
 *	Revision 1.56  2003/12/02 22:19:13  lewis
 *	SPR#1578: small fix to ProcessCmdLine code
 *	
 *	Revision 1.55  2003/11/30 01:59:30  lewis
 ...
 *	handles exceptions.
 *	
 *	Revision 1.54  2003/06/03 22:19:03  lewis
 *	SPR#1513: add spellcheck menu command for Gtk
 *	
 *	Revision 1.53  2003/05/30 17:29:32  lewis
 *	tweak mnemonics for Gtk/X
 *	
 *	Revision 1.52  2003/05/30 16:05:12  lewis
 *	SPR#1517: Linux/Gtk replace dialog support
 *	
 *	Revision 1.51  2003/05/08 00:11:26  lewis
 *	SPR#1467: added kSelectTableIntraCellAll_CmdID and cleaned up menu command name strings for new select commands(win32)
 *	
 *	Revision 1.50  2003/05/07 23:40:33  lewis
 *	SPR#1467: new Select menu for Linux/X/Gtk
 *	
 *	Revision 1.49  2003/05/07 21:14:08  lewis
 *	SPR#1467: new Select menu (and context menu) for Win32
 *	
 *	Revision 1.48  2003/04/15 22:36:41  lewis
 *	SPR#1425: added new 'Remove' menu and added to it RemoveTableRows/Cols, and moved Show/Hide Selection there
 *	
 *	Revision 1.47  2003/03/20 16:04:52  lewis
 *	SPR#1360 - get rid of EnterIdle calls - and made small change to version string
 *	
 *	Revision 1.46  2003/03/17 21:40:51  lewis
 *	SPR#1350 - qSupportEnterIdleCallback is now automatically true - and not a conditional varaible anymore
 *	
 *	Revision 1.45  2003/03/13 18:09:35  lewis
 *	fix aboutbox code to use qWideCharacters instead of qLed_CharacterSet and to use kUNICODE_NAME_ADORNER
 *	at all (for MacOS)
 *	
 *	Revision 1.44  2003/03/13 02:34:49  lewis
 *	SPR#1337 - I noted the indexes for the file formats where wrong in LedItApplication::ChooseDocument ()
 *	MACONLY CODE
 *	
 *	Revision 1.43  2003/03/11 21:45:24  lewis
 ...
 *	
 *	Revision 1.42  2003/03/11 02:31:21  lewis
 *	SPR#1288 - use new MakeSophistsAppNameVersionURL and add new CheckForUpdatesWebPageCommand
 *	
 *	Revision 1.41  2003/01/23 01:26:30  lewis
 *	SPR#1257 - try/catch for Led_URLManager::Open call in about box
 *	
 *	Revision 1.40  2002/12/06 15:45:21  lewis
 *	fix small bug in display of 'show hidden text' checkbox in menu (part of SPR#1197)
 *	
 *	Revision 1.39  2002/11/20 22:44:14  lewis
 *	spr#1177 - insert row/cols added for Linux menus
 *	
 *	Revision 1.38  2002/10/23 23:49:27  lewis
 *	add insert menu items
 *	
 *	Revision 1.37  2002/09/11 04:15:57  lewis
 *	SPR#1094- VERY preliminary Table support - an insert menu and InsertTable command
 *	
 *	Revision 1.36  2002/09/09 02:52:24  lewis
 *	update urls for led/sophists pages to 3.1
 *	
 *	Revision 1.35  2002/09/04 02:20:54  lewis
 *	if _MFC_VER>=0x700 then override WinHelpInternal() instead
 *	
 *	Revision 1.34  2002/05/06 21:31:05  lewis
 *	<========================================= Led 3.0.1 Released ========================================>
 *	
 *	Revision 1.33  2001/11/27 00:28:14  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 1.32  2001/10/06 14:58:02  lewis
 *	SPR#1054- for MFC build - move AddStandardTypes() call from CTOR to InitInstance() override
 *	
 *	Revision 1.31  2001/09/26 15:41:46  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.30  2001/09/26 15:05:18  lewis
 *	SPR#0996- fix call of EmbeddedObjectCreatorRegistry::Get ().AddStandardTypes ()
 *	to get called in common code (so called for xwindows as well)
 *	
 *	Revision 1.29  2001/09/20 13:21:10  lewis
 *	bump up macos chessebuf and Led_CheckSomeLocalHeapRAMAvailable () sizes since
 *	sizes have generally increased since this code was written
 *	
 *	Revision 1.28  2001/09/19 18:49:43  lewis
 *	touch up exception catching dialog display code (macos)
 *	
 *	Revision 1.27  2001/09/19 18:46:53  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.26  2001/09/18 19:18:15  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.25  2001/09/18 19:13:43  lewis
 *	SPR#0791- added support for toggle (use smart cut&paste, wrap-to-window,show
 *	hidden text) commands for MacOS
 *	
 *	Revision 1.24  2001/09/18 14:02:42  lewis
 ...
 *	
 *	Revision 1.23  2001/09/18 13:52:36  lewis
 *	change icon for RTF docs
 *	
 *	Revision 1.22  2001/09/17 14:42:17  lewis
 *	SPR#1032- added SetDefaultFont dialog and saved preferences (pref for new docs)
 *	
 *	Revision 1.21  2001/09/16 21:18:05  lewis
 *	fix so builds on Win32 FULL_UNICODE
 *	
 *	Revision 1.20  2001/09/16 18:35:09  lewis
 ...
 *	
 *	Revision 1.19  2001/09/12 14:49:56  lewis
 *	better exception handling messages, and lose some #if 0s
 *	
 *	Revision 1.18  2001/09/12 00:21:56  lewis
 *	SPR#1023- added LedItApplication::HandleBadUserInputException () code and other related fixes
 *	
 *	Revision 1.17  2001/09/06 22:01:15  lewis
 *	SPR#1003- Mac about box picture
 *	
 *	Revision 1.16  2001/09/06 20:26:31  lewis
 *	SPR#1003- cleanup aboutbox
 *	
 *	Revision 1.15  2001/08/29 22:59:18  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.14  2001/08/20 22:22:45  lewis
 *	SPR#0818- new display of URL objects (now just blue underlined slightly enlarged text). Can
 *	use qStandardURLStyleMarkerNewDisplayMode to get old code
 *	
 *	Revision 1.13  2001/07/19 19:53:15  lewis
 *	SPR#0961- Carbon support
 *	
 *	Revision 1.12  2001/07/19 02:22:38  lewis
 *	SPR#0960/0961- CW6Pro support, and preliminary Carbon SDK support.
 *	
 *	Revision 1.11  2001/06/05 15:44:07  lewis
 ...
 *	
 *	Revision 1.10  2001/06/05 13:35:38  lewis
 *	SPR#0949- Support popup in XWindows file picker to select file type, and adjust file suffixes (and for
 *	default filetype(autoguess) use file suffixes to guess).
 *	
 *	Revision 1.9  2001/06/04 20:55:03  lewis
 *	LedItApplication::UpdateFrameWindowTitle () to implement SPR#0932- update
 *	titlebar to say filename for XWindows
 *	
 *	Revision 1.8  2001/06/04 19:32:15  lewis
 *	SPR#0931 - use StdFilePickBox for Linux
 *	
 *	Revision 1.7  2001/05/24 14:25:06  lewis
 *	*** empty log message ***
 *	
 ...
 *	
 *	Revision 1.5  2001/05/18 23:00:12  lewis
 ...
 *	class - and now X-WIndows fully using LedDoc/LedView. Much more common code
 *	between implementations - but still a lot todo
 *	
...
Boolean	LedItApplication::ObeyCommand (CommandT	inCommand, void* ioParam)
{
	...
	switch (inCommand) {
		case	kToggleUseSmartCutNPasteCmd:	OnToggleSmartCutNPasteOptionCommand (); break;
		case	kToggleWrapToWindowCmd:			OnToggleWrapToWindowOptionCommand (); break;
		case	kToggleShowHiddenTextCmd:		OnToggleShowHiddenTextOptionCommand (); break;
		default:
											...
											)
{
	...
	outUsesMark = false;
	switch (inCommand) {
		case	kToggleUseSmartCutNPasteCmd:	OnToggleSmartCutNPasteOption_UpdateCommandUI (&Led_PP_TmpCmdUpdater (inCommand, outEnabled, outUsesMark, outMark, outName)); break;
		case	kToggleWrapToWindowCmd:			OnToggleWrapToWindowOption_UpdateCommandUI (&Led_PP_TmpCmdUpdater (inCommand, outEnabled, outUsesMark, outMark, outName)); break;
		case	kToggleShowHiddenTextCmd:		OnToggleShowHiddenTextOption_UpdateCommandUI (&Led_PP_TmpCmdUpdater (inCommand, outEnabled, outUsesMark, outMark, outName)); break;		
		default:
...
void	LedItApplication::ChooseDocument ()
{
	...
	if (filteredPicker.PickFile (&fileResult, &typeSpecified, &typeIndex)) {
		if (typeSpecified) {
			switch (typeIndex) {
				case	0:	format = eHTMLFormat; break;
				case	1:	format = eLedPrivateFormat; break;
				case	2:	format = eRTFFormat; break;
				case	3:	format = eTextFormat; break;
...
BOOL	LedItApplication::InitInstance ()
{
	...
	StandardMacPictureStyleMarker::sUnsupportedFormatPict = (const Led_DIB*)::LoadAppResource (kUnsupportedPICTFormatPictID, RT_BITMAP);
	...
	#if		qWindows
		{
			...
			Led_SDK_String	rtfDocIcon	=	Win32UIFileAssociationInfo::kNoChange;
			{
				Led_SDK_Char	buf[MAX_PATH + 100];
				(void)::_stprintf (buf, Led_SDK_TCHAROF ("$EXE$,%d"), -kLedItRTFDocumentIconID);
				rtfDocIcon = buf;
			}
								...
								)
{
	...
	switch (callback_action) {
		case	kGotoLedItWebPageCmd:			THIS->OnGotoLedItWebPageCommand (); break;
		case	kGotoSophistsWebPageCmd:		THIS->OnGotoSophistsWebPageCommand (); break;
		case	kCheckForUpdatesWebPageCmdID:	THIS->OnCheckForUpdatesWebPageCommand (); break;
		case	kAboutBoxCmd:					THIS->DoAboutBox (); break;
		case	kNewDocumentCmd:				THIS->OnNewDocumentCommand (); break;
		case	kOpenDocumentCmd:				THIS->OnOpenDocumentCommand (); break;
		case	kSaveDocumentCmd:				THIS->OnSaveDocumentCommand (); break;
		case	kSaveAsDocumentCmd:				THIS->OnSaveAsDocumentCommand (); break;
		case	kToggleUseSmartCutNPasteCmd:	THIS->OnToggleSmartCutNPasteOptionCommand (); break;
		case	kToggleWrapToWindowCmd:			THIS->OnToggleWrapToWindowOptionCommand (); break;
		case	kToggleShowHiddenTextCmd:		THIS->OnToggleShowHiddenTextOptionCommand (); break;
		case	kQuitCmd:						THIS->OnQuitCommand (); break;
...
void	LedItApplication::AppCmdOnInitMenu (GtkMenuItem* menuItem, gpointer callback_data)
{
	...
	GtkWidget*			w		=	THIS->fTextEditor->Get_GtkWidget ();
	{
		...
		for (GList* i = GTK_MENU_SHELL (subMenu)->children; i != NULL; i = i->next) {
			...
			switch  (commandNum) {
				case	kGotoLedItWebPageCmd:			gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				case	kGotoSophistsWebPageCmd:		gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				case	kCheckForUpdatesWebPageCmdID:	gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				case	kAboutBoxCmd:					gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				case	kNewDocumentCmd:				gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				case	kOpenDocumentCmd:				gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
	//NO - MUST FIX!!!			case	kSaveDocumentCmd:				THIS->OnSaveDocumentCommand (); break;
				case	kSaveAsDocumentCmd:				gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				case	kToggleUseSmartCutNPasteCmd:	THIS->OnToggleSmartCutNPasteOption_UpdateCommandUI (CMD_ENABLER (m, commandNum)); break;
				case	kToggleWrapToWindowCmd:			THIS->OnToggleWrapToWindowOption_UpdateCommandUI (CMD_ENABLER (m, commandNum)); break;
				case	kToggleShowHiddenTextCmd:		THIS->OnToggleShowHiddenTextOption_UpdateCommandUI (CMD_ENABLER (m, commandNum)); break;
				case	kQuitCmd:						gtk_widget_set_sensitive (GTK_WIDGET (m), true); break;
				default:								THIS->fTextEditor->DispatchCommandUpdateCallback (m, commandNum);
			}
		}
	}
}

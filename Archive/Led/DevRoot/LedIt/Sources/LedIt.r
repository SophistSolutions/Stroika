...
/*
 * $Header: /cygdrive/k/CVSRoot/LedIt/Sources/LedIt.r,v 1.31 2004/02/11 22:41:32 lewis Exp $
 *
 * Description:
 *
 *
 ...
 * Changes:
 *	$Log: LedIt.r,v $
 *	Revision 1.31  2004/02/11 22:41:32  lewis
 *	SPR#1576: update: added 'Replace Again' command to LedIt, LedLineItMFC, ActiveLedIt
 *	
 *	Revision 1.30  2003/06/03 22:15:33  lewis
 *	SPR#1513: add spellcheck command for MacOS
 *	
 *	Revision 1.29  2003/05/30 14:43:16  lewis
 *	SPR#1517: MacOS replace dialog support
 *	
 *	Revision 1.28  2003/05/08 18:14:48  lewis
 *	add accidentially forgotten kRemoveMenuID to the MBAR
 *	
 *	Revision 1.27  2003/05/08 14:47:45  lewis
 *	lose selectall from edit menu since its in 'select' menu
 *	
 *	Revision 1.26  2003/05/08 00:11:25  lewis
 *	SPR#1467: added kSelectTableIntraCellAll_CmdID and cleaned up menu command name strings
 *	for new select commands(win32)
 *	
 *	Revision 1.25  2003/05/07 23:34:37  lewis
 *	SPR#1467: new Select menu for MacOS
 *	
 *	Revision 1.24  2003/04/15 22:36:40  lewis
 *	SPR#1425: added new 'Remove' menu and added to it RemoveTableRows/Cols, and moved Show/Hide
 *	Selection there
 *	
 *	Revision 1.23  2003/04/07 14:11:20  lewis
 *	SPR#1414: finished fixing liststyle support for MacOS
 *	
 *	Revision 1.22  2003/04/07 13:27:30  lewis
 *	SPR#1412: for MacOS - add list style menu and indent/unindent
 *	
 *	Revision 1.21  2003/03/11 21:49:05  lewis
 *	small menu cleanups - including naming size menu items '# pt'
 *	
 *	Revision 1.20  2003/01/22 01:08:24  lewis
 *	SPR#1256 - OtherSize&ParagraphSpacing dialogs moved to LedStdDialogs(untested on Mac).
 *	
 *	Revision 1.19  2003/01/21 16:48:21  lewis
 *	typo
 *	
 *	Revision 1.18  2003/01/21 13:25:54  lewis
 *	SPR#1186 - first cut at Indents dialog support
 *	
 *	Revision 1.17  2003/01/20 20:52:58  lewis
 *	SPR#1251 - added 'carb' resource so can run native on OS X
 *	
 *	Revision 1.16  2002/11/20 19:42:53  lewis
 *	SPR#1177 added insert row/col cmds for MacOS tables
 *	
 *	Revision 1.15  2002/10/24 02:21:24  lewis
 *	SPR#1137- add insert menu for LedIt Mac
 *	
 *	Revision 1.14  2002/05/06 21:31:04  lewis
 *	<========================================= Led 3.0.1 Released ========================================>
 *	
 *	Revision 1.13  2001/11/27 00:28:12  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 1.12  2001/09/19 15:45:19  lewis
 *	up finder partition size to 1024K (so copy/paste works decently with large copies)
 *	
 *	Revision 1.11  2001/09/18 19:13:42  lewis
 *	SPR#0791- added support for toggle (use smart cut&paste, wrap-to-window,show hidden text)
 *	commands for MacOS
 *	
 *	Revision 1.10  2001/09/18 14:02:41  lewis
 ...
 *	
 *	Revision 1.9  2001/09/12 00:21:55  lewis
 *	SPR#1023- added LedItApplication::HandleBadUserInputException () code and other related fixes
 *	
 *	Revision 1.8  2001/09/07 15:45:16  lewis
 *	resourcerer demo said MENU and wctb resources should not have purgeable bit set. I have no
 *	idea - so comply
 *	
 *	Revision 1.7  2001/09/06 22:01:14  lewis
 *	SPR#1003- Mac about box picture
 *
 *	Revision 1.6  2001/08/29 22:59:18  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.5  2001/08/20 22:22:45  lewis
 ...
 *	
 *	Revision 1.4  2001/08/17 00:00:39  lewis
 *	SPR#0959- GetSelInfo menu items for MacOS
 *	
 *	Revision 1.3  2001/05/18 23:00:11  lewis

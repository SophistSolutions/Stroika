...
/*
 * $Header: /cygdrive/k/CVSRoot/LedIt/Sources/FormatToolbar.cpp,v 1.7 2003/03/21 15:00:28 lewis Exp $
 *
 * Description:
 *
 *
 ...
 *	Revision 1.7  2003/03/21 15:00:28  lewis
 *	SPR#1368 - added CRTDBG_MAP_ALLOC_NEW support
 *	
 *	Revision 1.6  2002/05/06 21:31:03  lewis
 *	<========================================= Led 3.0.1 Released ========================================>
 *	
 *	Revision 1.5  2001/11/27 00:28:12  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 1.4  2001/08/29 22:59:18  lewis
 *	*** empty log message ***
 *	
 *	Revision 1.3  2001/05/16 16:03:18  lewis
 *	more massive changes. Make Options () stuff portable (though fake impl om mac/X).
 *	Got rid of AppWindow class - and now X-WIndows fully using LedDoc/LedView. Much
 *	more common code between implementations - but still a lot todo
 *	
 ...
 *	
 *	Revision 1.1  2001/05/14 20:54:46  lewis

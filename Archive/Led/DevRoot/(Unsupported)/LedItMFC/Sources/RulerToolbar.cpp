...
/*
 * $Header: /cygdrive/k/CVSRoot/(Unsupported)/LedItMFC/Sources/RulerToolbar.cpp,v 1.7 2000/06/13 16:29:33 lewis Exp $
 *
 * Description:
 *
 *
 ...
 *
 * Changes:
 *	$Log: RulerToolbar.cpp,v $
 *	Revision 1.7  2000/06/13 16:29:33  lewis
 *	SPR#0767- use TWIPS for tabstops etc inernally in Led
 *	
 *	Revision 1.6  1999/02/11 02:41:13  lewis
 *	cosmetic code cleanups
 *	
 *	Revision 1.5  1999/02/10 16:22:18  lewis
 ...
 *	
 *	Revision 1.4  1998/10/30 14:55:04  lewis
 *	Misc fixes for Led changes, and fix toolbar code to and with CBRS_ALL before asign to m_dwStyle.
 *	(mfc60 crashes otherwise).
 *	
 *	Revision 1.3  1998/04/25  01:51:55  lewis
 *	Code cleanups, and Get/Set ParaFormatSelection support to get/set tabstops in ruler actually into LedItView.
 *

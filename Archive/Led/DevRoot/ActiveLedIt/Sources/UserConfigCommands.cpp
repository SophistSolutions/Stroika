...
/*
 * $Header: /cygdrive/k/CVSRoot/ActiveLedIt/Sources/UserConfigCommands.cpp,v 2.12 2004/02/09 16:25:19 lewis Exp $
 *
 * Description:
 *
 * TODO:
 ...
 *
 * Changes:
 *	$Log: UserConfigCommands.cpp,v $
 *	Revision 2.12  2004/02/09 16:25:19  lewis
 ...
 *	
 *	Revision 2.11  2004/02/07 21:20:20  lewis
 ...
 *	
 *	Revision 2.10  2004/02/07 19:20:33  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.9  2004/02/06 01:36:06  lewis
 ...
 *	
 *	Revision 2.8  2004/02/04 21:16:22  lewis
 ...
 *	
 *	Revision 2.7  2004/02/03 03:39:45  lewis
 *	SPR#1618: added print command to toolbar. Forced fixing a couple bugs - using MFC UnUpdate dispatcher
 *	(CCmdUI.DoUpdate) instead of Led one - because currently some commands - like print - use the MFC dispatch
 *	mechanism (could have redone to juse use Led one). Also - fixed commandname matcher to match properly on
 *	kAllCmds list using INTENRALNAME mapper
 *	
 *	Revision 2.6  2004/02/02 23:02:41  lewis
 ...
 *	
 *	Revision 2.5  2004/01/30 04:36:36  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.4  2004/01/25 21:51:49  lewis
 ...
 *	
 *	Revision 2.3  2004/01/25 16:19:30  lewis
 ...
 *	
 *	Revision 2.2  2004/01/24 03:50:08  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.1  2004/01/23 23:11:26  lewis
				...
				if (accelElt.p != NULL) {
					...
					if (modFlag & eVIRTKEY) {
						if (VK_F1 <= key and key <= VK_F12) {
							suffix += Led_SDKString2Wide (Format (Led_SDK_TCHAROF ("F%d"), key+1-VK_F1));
						}
...
WORD	CmdObjOrName2Num (const VARIANT& cmdObjOrName)
{
	...
	if (SUCCEEDED (c.ChangeType (VT_BSTR))) {
		...
		for (const BuiltinCmdSpec* i = kAllCmds; i != kAllCmds + Led_NEltsOf (kAllCmds); ++i) {

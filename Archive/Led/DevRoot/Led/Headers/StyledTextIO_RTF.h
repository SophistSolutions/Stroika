...
/*
 * $Header: /cygdrive/k/CVSRoot/Led/Headers/StyledTextIO_RTF.h,v 2.76 2004/01/21 02:18:56 lewis Exp $
 */
...
class	StyledTextIOReader_RTF::ReaderContext::SinkStreamDestination : public StyledTextIOReader_RTF::ReaderContext::Destination_ {
	...
	public:
		override	void	AppendText (const Led_tChar* text, size_t nTChars);
		override	void	AppendEmbedding (SimpleEmbeddedObjectStyleMarker* embedding);
		override	void	AppendSoftLineBreak ();
		override	void	EndParagraph ();
		override	void	UseFont (const Led_IncrementalFontSpecification& fontSpec);
		override	void	SetJustification (Led_Justification justification);
		override	void	SetTabStops (const TextImager::StandardTabStopList& tabStops);
		...
		override	void	SetSpaceBefore (Led_TWIPS tx);
		override	void	SetSpaceAfter (Led_TWIPS tx);
		override	void	SetSpaceBetweenLines (Led_Coordinate tx);
		override	void	SetSpaceBetweenLinesMult (bool multipleLineSpacing);
		override	void	SetTextHidden (bool hidden);
		override	void	SetInTable (bool inTable);
		override	void	EndRow (bool forceEmit = false);
		override	void	EndCell (bool forceEmit = false);
		...
		override	void	SetCellX (Led_TWIPS cellx);
		override	void	SetCellBackColor (const Led_Color& c);
		override	void	Call_trowd ();
		override	void	Set_trleft (Led_TWIPS t);
		override	void	SetDefaultCellMarginsForRow_top (Led_TWIPS t);
		override	void	SetDefaultCellMarginsForRow_left (Led_TWIPS t);
		override	void	SetDefaultCellMarginsForRow_bottom (Led_TWIPS t);
		override	void	SetDefaultCellMarginsForRow_right (Led_TWIPS t);
		override	void	SetDefaultCellSpacingForRow_top (Led_TWIPS t);
		override	void	SetDefaultCellSpacingForRow_left (Led_TWIPS t);
		override	void	SetDefaultCellSpacingForRow_bottom (Led_TWIPS t);
		override	void	SetDefaultCellSpacingForRow_right (Led_TWIPS t);
	...
	public:
		override	Context	GetContext () const;
		override	void	SetContext (const Context& c);

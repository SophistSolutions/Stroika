...
/*
 * $Header: /cygdrive/k/CVSRoot/Led/Sources/LedStdDialogs.r,v 2.42 2004/02/12 20:35:20 lewis Exp $
 *
 * Changes:
 *	$Log: LedStdDialogs.r,v $
 *	Revision 2.42  2004/02/12 20:35:20  lewis
 *	SPR#1576: fixup MacOS Replace dialog layout (new replace all in selection button)
 *	
 *	Revision 2.41  2004/02/11 23:57:55  lewis
 *	SPR#1576: Update: added ReplaceAllInSelection functionality (except must re-layout MacOS dialog)
 *	
 *	Revision 2.40  2003/12/13 02:32:39  lewis
 *	fixed typo in mac resource definitions
 *	
 *	Revision 2.39  2003/12/13 01:56:35  lewis
 *	tweek visual display of Mac spellcheck dialog
 *	
 *	Revision 2.38  2003/12/11 01:31:58  lewis
 ...
 *	
 *	Revision 2.37  2003/06/03 22:14:15  lewis
 *	SPR#1513: MacOS spellcheck dialog work
 *	
 *	Revision 2.36  2003/06/02 16:14:00  lewis
 *	SPR#1513: first draft of (windows only so far) simple spellchecking dialog. Basically
 *	working (75%). A few fixes to generic dialog support code
 *	
 *	Revision 2.35  2003/05/30 15:59:39  lewis
 *	SPR#1517: MacOS Replace dialog support
 *	
 *	Revision 2.34  2003/05/30 03:06:55  lewis
 *	SPR#1517: preliminary version of REPLACE DIALOG support (WIN32 only so far).
 *	
 *	Revision 2.33  2003/05/14 20:47:11  lewis
 *	SPR#1399 and SPR#1401: finished MacOS implemenation of add table /edit table dialogs
 *	
 *	Revision 2.32  2003/05/14 17:52:25  lewis
 *	SPR#1399: first cut at MacOS AddTable/EditTable dialogs
 *	
 *	Revision 2.31  2003/05/13 20:44:50  lewis
 *	SPR#1399: progress checking on table getproperties dialog support
 *	
 *	Revision 2.30  2003/05/12 17:17:45  lewis
 *	SPR#1401: Added GetDialogSupport ().AddNewTableDialog () and Led_StdDialogHelper_AddNewTableDialog.
 *	
 *	Revision 2.29  2003/03/14 00:00:01  lewis
 *	hack versionstring field size again so fits better on MacOS for INTENRAL UNICODE
 *	
 *	Revision 2.28  2003/03/13 18:33:08  lewis
 *	tweek mac versionstring to be a tiny bit wider (cuz of 'INTERNAL UNICODE')
 *	
 *	Revision 2.27  2003/01/30 22:13:38  lewis
 *	SPR#1272 - change windows dialog font
 *	
 *	Revision 2.26  2003/01/23 16:48:59  lewis
 *	SPR#1250 - cleanup appearance of Windows dialogs
 *	
 *	Revision 2.25  2003/01/23 02:57:03  lewis
 *	cosmetic cleanups
 *	
 *	Revision 2.24  2003/01/22 22:48:10  lewis
 ...
 *	
 *	Revision 2.23  2003/01/22 01:09:11  lewis
 *	SPR#1256 - OtherSize&ParagraphSpacing dialogs moved to LedStdDialogs(untested on Mac).
 *	
 *	Revision 2.22  2003/01/21 23:00:26  lewis
 *	small layout cleanups for Find / Paragraph Indents dialogs (MacOS) and pasted in sample .r
 *	MAC code for CNTLs (delete after use)
 *	
 *	Revision 2.21  2003/01/21 19:23:09  lewis
 *	SPR#1250 - cleanup find dialog(WIN32)
 *	
 *	Revision 2.20  2003/01/21 16:47:16  lewis
 *	SPR#1250 - prelim version of Mac ParagraphIndents dialog
 *	
 *	Revision 2.19  2003/01/21 13:26:56  lewis
 *	SPR#1186 - first cut at Indents dialog support (MacOS dialog still not done)
 *	
 *	Revision 2.18  2002/10/22 00:38:59  lewis
 *	Add URL context/menu command - SPR#1136
 *	
 *	Revision 2.17  2002/05/06 21:33:44  lewis
 *	<=============================== Led 3.0.1 Released ==============================>
 *	
 *	Revision 2.16  2001/11/27 00:29:50  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 2.15  2001/09/26 15:41:18  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.14  2001/09/16 18:33:58  lewis
 ...
 *	
 *	Revision 2.13  2001/09/07 15:48:38  lewis
 *	SPR#0997- make about box look better on Mac - background color and centered.
 *	Tried to fix font choice but failed (OK)
 *	
 *	Revision 2.12  2001/09/06 20:25:32  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.11  2001/08/29 23:36:32  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.10  2001/08/28 18:43:35  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.9  2001/08/17 00:00:03  lewis
 *	SPR#0959- Fix GetSelInfo stuff for MacOS (dialogs)
 *	
 *	Revision 2.8  2001/07/17 19:09:38  lewis
 *	SPR#0959- added preliminary RightClick-to-show-edit-embedding-properties support
 *	
 *	Revision 2.7  2000/10/19 15:59:50  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.6  2000/10/19 15:50:23  lewis
 *	lots more work on dialogs on Mac. Use dlgx resource to support movable modal.
 *	Cleanup display. Support togglying checkbox, and full grabing / setting of values
 *	in dialog. Support event filterproc. Now portable mac/windows dialog support does
 *	about everything I need to replace what I was getting from PowerPlant
 *	
 *	Revision 2.5  2000/10/18 20:39:55  lewis
 *	Added Led_StdDialogHelper_FindDialog support. Works on Windows and prelim for Mac
 *	
 *	Revision 2.4  2000/10/17 18:16:11  lewis
 *	mac aboutbox work
 *	
 *	Revision 2.3  2000/10/16 19:35:41  lewis
 *	remove OK button from mac about box
 *	

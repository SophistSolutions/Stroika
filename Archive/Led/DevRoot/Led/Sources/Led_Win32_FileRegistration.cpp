...
/*
 * $Header: /cygdrive/k/CVSRoot/Led/Sources/Led_Win32_FileRegistration.cpp,v 2.8 2003/04/17 13:42:02 lewis Exp $
 *
 * Changes:
 *	$Log: Led_Win32_FileRegistration.cpp,v $
 *	Revision 2.8  2003/04/17 13:42:02  lewis
 *	*** empty log message ***
 *	
 *	Revision 2.7  2003/04/16 17:26:48  lewis
 ...
 *	
 *	Revision 2.6  2003/03/21 14:50:57  lewis
 *	added CRTDBG_MAP_ALLOC_NEW support
 *	
 *	Revision 2.5  2002/05/06 21:33:47  lewis
 *	<=============================== Led 3.0.1 Released ==============================>
 *	
 *	Revision 2.4  2002/05/01 22:05:43  lewis
 *	add explicit CTOR call to avoid warnings of mulitple implicit conversions from VC7.Net compiler
 *	
 *	Revision 2.3  2001/11/27 00:29:53  lewis
 *	<=============== Led 3.0 Released ===============>
 *	
 *	Revision 2.2  2001/09/16 21:13:40  lewis
 ...
 */
	...
	inline	Win32FileAssociationRegistrationHelper::KeyHolder::KeyHolder (HKEY baseKey, LPCTSTR lpSubKey, CreateIfNotThereFlag createIfNotThereFlag):
			fKey (NULL)
		{
			Led_Assert (createIfNotThereFlag == eCreateIfNotThere);
			DWORD	ignored	=	0;
...
Led_SDK_String	Win32FileAssociationRegistrationHelper::GetAssociatedProgID () const
{
	try {
		...
		Led_SmallStackBuffer<Led_SDK_Char> buf (itemLen + 1);
...
void	Win32UIFileAssociationRegistrationHelper::DoIt () throw ()
{
	/*

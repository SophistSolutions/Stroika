...
{
	switch (dd) {
		case eUniformDist:		return GetUniformIndices ();
		case eNormalizedDist:	return GetNormalIndices ();
		case eZipfDist:			return GetZipfIndices ();
		default:                break;
	}
	AssertNotReached (); return GetUniformIndices ();
}

...
/*
 * $Header: /fuji/lewis/RCS/tMapping_Array.cc,v 1.4 1992/12/03 07:45:01 lewis Exp $
 *
 * TODO:
 *
 * Changes:
 *	$Log: tMapping_Array.cc,v $
...
#include	"TestSuite.hh"
	...
	#include 	"TFileMap.hh"
	#include	Mapping_ArrayOfSimpleClass_UInt32_hh
...
{
	cout << "Testing Mapping_Array" << endl;

	{
#if		qRealTemplatesAvailable
		Mapping_Array<SimpleClass, UInt32>	s;
#else
		Mapping_Array(SimpleClass, UInt32)	s;
#endif
	...
	cout << "Finished testing Mapping_Array" << endl;
	return (0);
}

...
/*
 * $Header: /fuji/lewis/RCS/tMapping_HashTable.cc,v 1.10 1992/12/03 07:45:01 lewis Exp $
 *
 * TODO:
 *
 * Changes:
 *	$Log: tMapping_HashTable.cc,v $
 *		Revision 1.10  1992/12/03  07:45:01  lewis
 *		Work around qGCC_SimpleClassStaticInitializerBug.
 *
 *		Revision 1.9  1992/11/26  02:54:03  lewis
 *		Minor cleanups for templates, etc...
 *
 *		Revision 1.8  1992/10/10  04:43:31  lewis
...
#include	"TestSuite.hh"
	...
	#include 	"TFileMap.hh"
	#include	Mapping_HashTableOfSimpleClass_UInt32_hh
#endif	/*!qRealTemplatesAvailable*/

static	size_t	SimpleClassHashFunction (const SimpleClass& key)
{
	return (key.GetValue ());
}
...
{
	cout << "Testing Mapping_HashTable" << endl;

	{
#if		qRealTemplatesAvailable
		Mapping_HashTable<SimpleClass, UInt32>	s;
#else
		Mapping_HashTable(SimpleClass, UInt32)	s (&SimpleClassHashFunction, 1001);
#endif
		SimpleMappingTests (s);
	}

	cout << "Finished testing Mapping_HashTable" << endl;
	return (0);
}

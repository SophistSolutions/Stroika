...
/*
 * $Header: /fuji/lewis/RCS/tMapping_SortedArray.cc,v 1.4 1992/12/03 07:45:01 lewis Exp $
 *
 * TODO:
 *
 * Changes:
 *	$Log: tMapping_SortedArray.cc,v $
...
#include	"TestSuite.hh"
	...
	#include 	"TFileMap.hh"
	#include	Mapping_SortedArrayOfSimpleClass_UInt32_hh
#endif	/*!qRealTemplatesAvailable*/

int	main (int /*argc*/, char* /*argv*/[])
{
	cout << "Testing Mapping_SortedArray" << endl;

	{
#if		qRealTemplatesAvailable
		Mapping_SortedArray<SimpleClass, UInt32>	s;
#else
		Mapping_SortedArray(SimpleClass, UInt32)	s;
#endif
	...
	cout << "Finished testing Mapping_SortedArray" << endl;
	return (0);
}

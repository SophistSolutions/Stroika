...
/*
 * $Header: /fuji/lewis/RCS/tMapping_LinkList.cc,v 1.4 1992/12/03 07:45:01 lewis Exp $
 *
 * TODO:
 *
 * Changes:
 *	$Log: tMapping_LinkList.cc,v $
...
#include	"TestSuite.hh"
	...
	#include 	"TFileMap.hh"
	#include	Mapping_LinkListOfSimpleClass_UInt32_hh
...
{
	cout << "Testing Mapping_LinkList" << endl;

	{
#if		qRealTemplatesAvailable
		Mapping_LinkList<SimpleClass, UInt32>	s;
#else
		Mapping_LinkList(SimpleClass, UInt32)	s;
#endif
	...
	cout << "Finished testing Mapping_LinkList" << endl;
	return (0);
}

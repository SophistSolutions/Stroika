...
- `for i in Stroika-Dev Stroika-Dev-2204 Stroika-Dev-2404 Stroika-Dev-2410 Stroika-Dev-2504; do docker start $i; docker exec -it $i sudo service ssh start; done`
